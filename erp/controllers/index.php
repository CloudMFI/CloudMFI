		...
		<div class="col-lg-12 ">
			<div class="col-md-5">
				...
				<div class="form-group all">
					...
					<?= form_input('c_amount', (isset($_POST['c_amount']) ? $_POST['c_amount'] : ''), 'class="form-control" id="c_amount"'); ?>
				</div>
				...
				<div class="form-group">
					...
					$frequency[180] = "Haft Year";
					$frequency[360] = "Yearly";
					echo form_dropdown('c_frequency', $frequency, (isset($_POST['c_frequency']) ? $_POST['c_frequency'] : ''), 'class="form-control" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("frequency") . '" id="c_frequency"');
					?>
				</div>
			...
			<div class="col-md-5" style="padding-top: 25px;">
				<div>
					<div style="font-weight:bold;"><p style="float: left; margin-right: 15px; margin-top: 10px;">Total Interest&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</p><p id="c_ap-show" style="font-size:25px !important;"><?= $this->erp->formatMoney(0); ?></p></div>
				</div>
				<div class="modal-footer">
					<button class="btn btn-primary" style="display:none;" id="simulate"><?php echo lang('simulate');?></button>
