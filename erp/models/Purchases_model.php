...
class Purchases_model extends CI_Model
{
	...
	public function getbrachByID($id)
    {
    ...
    public function addExpense($data = array(), $payment = array()){
		$branch = $this->getbrachByID($data['biller_id']);
		//$branchamount = $branch->amount - $data['amount'];
        if ($this->db->insert('expenses', $data)){
			...
			//$this->db->update('companies', array('amount' => $branchamount), array('id' => $branch->id));			
            return true;
        }
        return false;
    }
    ...
    public function updateExpense($id, $data = array(), $data_payment = array()){
		...
		$branch = $this->getbrachByID($data['biller_id']);
		$old_branchamount = $branch->amount + $expense->amount;		
		//$branchamount = $old_branchamount - $data['amount'];
