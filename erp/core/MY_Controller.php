...
class MY_Controller extends CI_Controller {
    ...
    function __construct()
    {
        ...
        if($this->loggedIn) {
			...
			$this->GP = $this->erp->in_group('GP') ? TRUE : NULL;
            $this->data['GP'] = $this->GP;
            ...
            $this->data['m']= $this->m;
            $this->data['v'] = $this->v;
			$this->data['send_dates'] = $this->site->getSendDate(); //$this->erp->print_arrays($this->site->getSendDate());
    ...
    function page_construct($page, $meta = array(), $data = array()) {
		...
		$meta['new_applicant'] = $this->site->getNewApplicant();
		$meta['approved_applicant'] = $this->site->getApprovedApplicant();
		$meta['activated_applicant'] = $this->site->getActivatedApplicant();
		...
		$meta['getBranchName'] =$this->site->getBranchByUserIdForHead($this->session->userdata('user_id'));
