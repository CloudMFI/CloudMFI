													...
													<div class="col-lg-12">
														...
														<div class="col-md-6" style="margin-top:15px;">
															...
															<div class="col-md-4">
																...
																<div>
																	<label for="document">Photo Applicant</label>
															...
															<div class="col-sm-12">
																...
																<div class="col-md-4">
																	<div class="form-group">
																		...
																		<?php
																		echo form_input('sub_category', isset($product->subcategory_id) ?$product->subcategory_id  : (''), 'class="form-control sub_category sub_categ" id="sub_category"  placeholder="' . lang("select_category_to_load") . '"');
																		?>
																	</div>
																</div>
																...
																<div class="col-md-4">
																	<div class="form-group">
																		...
																		echo form_input('product_id', isset($product->product_id) ?$product->product_id  : (''), 'class="form-control product_id produc" id="product_id"  placeholder="' . lang("select_product_to_load") . '" ');
																		?>
																	</div>
																</div>
																<div class="col-md-4" id="group_loans1" style="display:none;">
																...
																<div class="col-md-4 show_cash">
																	<div class="form-group">
																		...
																		echo form_dropdown('currency', $crr, (isset($product->currency_code) ? $product->currency_code  : ''), 'class="form-control currency" id="currency" placeholder="' . lang("select_currency") . '"');
																		?>
																	</div>
																</div>
													...
													<div class="panel panel-primary">
														...
														<div class="panel-body" style="padding: 5px;">
															...
															<div class="col-sm-12">
																...
																<div class="col-md-3">
																	<div class="form-group">
																		<?php echo form_input('service[]', (($service->method == 'Percentage')? $this->erp->formatNumber($service->amount*100).'%' : $this->erp->formatMoney($service->amount)), 'class="form-control input-tip services" id="services" '); ?>
																	</div>
																</div>
																<div class="col-md-3">
																	<div class="form-group">
																		<input type="checkbox" class="form-control ch_services" amount="<?php echo isset($service->amount ) ?$service->amount   : ('')?>" status="<?= $service->method; ?>" name="ch_services[]" value="1" <?php echo set_checkbox('ch_services[]', '1', isset($quote_service[$k]->quote_id)==$id?TRUE:FALSE); ?>>
																	</div>
																</div>
																<?php
																if($k == 0) {
												...
												<div class="col-sm-12 hide_cash-show" style="display:none">
													<div class="panel panel-primary">
														...
														<div class="panel-body" style="padding: 5px;">
															<div class="col-lg-6">
																...
																<div class="form-group">
																	...
																	*/
																	...
																	<?php
																		echo form_input('interest_rate_cash_2', (isset($inv->rate_text ) ? $inv->rate_text : ''), 'class="form-control" id="interest_rate_cash_2"  required="required"') 
																	?>
																</div>
															</div>
															<div class="col-lg-6">
																<div class="form-group">
																	...
																	echo form_dropdown('term_cash', $term, (isset($inv->term) ? $inv->term : ''), 'id="term_cash" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("term") . '" class="form-control input-tip select" style="width:100%;"');
																	?>
																</div>
																<div class="form-group">
															...
															<div class="col-lg-6 btn_print_payment_schedule_cash" style="display:none; padding-bottom: 1%;">
												...
												<div class="col-md-12">
													...
													<div class="table-responsive">	
														<table class="table">
															<tbody>
															  <tr>
																<td><input type="checkbox" name="fc_evaluate" id="evaluate" <?= ($field_check && $field_check->go_there)? 'checked':''?> >ចុះវាយតំលៃ</td>
																<td><input type="checkbox" name="fc_none_evaluate" id="none_evaluate" <?= ($field_check && $field_check->not_go_there)? 'checked':''?> >មិនចុះវាយតំលៃ</td>
																<td><p>ឈ្មោះមន្រ្តីចុះវាយតម្លៃ :</p></td>
