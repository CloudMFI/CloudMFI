...
function loadItems() {
    ...
    if (localStorage.getItem('quitems')) {
        ...
        tfoot += '<th class="text-right">'+formatMoney(total)+'<input type="hidden" name="total_amount" id="total_amount" value="'+total+'" /></th><th class="text-center"><i class="fa fa-trash-o" style="opacity:0.5; filter:alpha(opacity=50);"></i></th></tr>';
