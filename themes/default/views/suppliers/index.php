...
<script>
    $(document).ready(function () {
        var oTable = $('#SupData').dataTable({
            ...
            {column_number: 6, filter_default_label: "[<?=lang('province');?>]", filter_type: "text", data: []},
            ...
            {column_number: 9, filter_default_label: "[<?=lang('account_number');?>]", filter_type: "text", data: []},
            {column_number: 10, filter_default_label: "[<?=lang('account_name');?>]", filter_type: "text", data: []},
        ], "footer");
    });
</script>
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('list_dealers'); ?></h2>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= site_url('suppliers/add'); ?>" data-toggle="modal" data-target="#myModal"
                               id="add"><i class="fa fa-plus-circle"></i> <?= lang("add_dealer"); ?></a></li>
                        <li><a href="#" id="excel" data-action="export_excel"><i
                                    class="fa fa-file-excel-o"></i> <?= lang('export_to_excel') ?></a></li>
                        <li><a href="#" id="pdf" data-action="export_pdf"><i
                                    class="fa fa-file-pdf-o"></i> <?= lang('export_to_pdf') ?></a></li>
                        <li class="divider"></li>
                        <li><a href="#" class="bpo" title="<?= $this->lang->line("delete_dealers") ?>"
                               data-content="<p><?= lang('r_u_sure') ?></p><button type='button' class='btn btn-danger' id='delete' data-action='delete'><?= lang('i_m_sure') ?></a> <button class='btn bpo-close'><?= lang('no') ?></button>"
                               data-html="true" data-placement="left"><i
                                    class="fa fa-trash-o"></i> <?= lang('delete_dealer') ?></a></li>
                    </ul>
                </li>
            </ul>
        </div>
