       ...
       ?>
		...
		<li class="dropdown">
			...
			<div class="box-content">
				<div class="row">
					<div class="col-lg-12">
						<p class="introtext"><?= lang('AR Aging'); ?></p>
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										echo form_dropdown('biller', isset($bl) ?$bl  : (''), (isset($_POST['biller']) ? $_POST['biller'] : ""), 'class="form-control" id="biller" data-placeholder="' . $this->lang->line("select") . " " . $this->lang->line("biller") . '"');
										?>
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										...
										echo form_dropdown('warehouse', isset($wh) ?$wh  : (''), (isset($_POST['warehouse']) ? $_POST['warehouse'] : ""), 'class="form-control" id="warehouse" data-placeholder="' . $this->lang->line("select") . " " . $this->lang->line("warehouse") . '"');
										?>
									</div>
								</div>
