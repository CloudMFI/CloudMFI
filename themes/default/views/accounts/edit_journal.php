			...
			<div class="col-md-12">
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<div class="input-group">  
							<?php echo form_input('reference_no', $journal1->reference_no, 'class="form-control" id="reference" '); ?>
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						echo form_dropdown('biller_id', $bl, ($biller_id ? $biller_id : ""), 'class="form-control" id="biller" data-placeholder="' . $this->lang->line("select") . " " . $this->lang->line("branch") . '" required="required"');
						?>
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						echo form_dropdown('type', $type_l, ($journal1->created_type ? $journal1->created_type : ""), 'class="form-control" id="type" data-placeholder="' . $this->lang->line("select") . " " . $this->lang->line("type") . '"');
						?>
					</div>
				</div>
				 ...
				 <div class="col-md-4">
					<div class="form-group">
						...
						<?php } ?>
							<?php
							if ($Owner || $Admin ) { 
								echo form_input('name', $journal1->created_name, 'class="form-control" id="name" style="width:250px"  placeholder="' . lang("select_name") . '"');
							?>
							<div class="input-group-addon no-print" style="padding: 2px 5px;">
								<a href="<?= site_url('system_settings/add_subcategory'); ?>" id="add-supplier"
				...
				<div class="col-md-12 journal-list">
					...
					<div class="col-md-4">
						<div class="form-group margin-b-5">	
							<?php echo form_input('debit[]', $this->erp->formatDecimal($journal->debit), 'class="form-control debit" id="debit debit'. $n .'"'); ?>
						</div>
					</div>
					
					<div class="col-md-3">
						<div class="form-group margin-b-5">
							<?php echo form_input('credit[]', $this->erp->formatDecimal($journal->credit), 'class="form-control credit" id="credit credit'.$n .'"'); ?>
						</div>
					</div>
					<div class="col-md-1">
						<div class="form-group margin-b-5">
...
<script type="text/javascript">
	...
	{     
		...
		{ 
			...
			div += '			<label><button type="button" data="'+FieldCount+'" class="removefile btn btn-danger" style="position:relative;top:-5px;">&times;</button></label>';
			div += '		</div>';
			div += '	</div>';
