<script>
    $(document).ready(function () {
        var oTable = $('#SupData').dataTable({
			...
			{column_number: 3, filter_default_label: "[<?=lang('account_name_kh');?>]", filter_type: "text", data: []},
            {column_number: 4, filter_default_label: "[<?=lang('parent_account');?>]", filter_type: "text", data: []},
            {column_number: 5, filter_default_label: "[<?=lang('account_section');?>]", filter_type: "text", data: []},
        ], "footer");
    });
</script>
<?php if ($Owner) {
