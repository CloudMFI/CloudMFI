    ...
    $(document).ready(function () {
        var oTable = $('#SupData').dataTable({
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            },  { "width": "25px" },null, null, {"mRender": fld }, null, null,null, null, null, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"bSortable": false}],
			...
			{column_number: 8, filter_default_label: "[<?=lang('name');?>]", filter_type: "text", data: []},
