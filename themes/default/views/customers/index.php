    ...
    $(document).ready(function () {
        ...
        var cTable = $('#CusData').dataTable({
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, {"mRender": center}, null, null, {"mRender": fld}, null,{"bSortable": false}]
        }).dtFilter([
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="CusData" cellpadding="0" cellspacing="0" border="0" width="100%"
                        ...
                        <tr class="primary">
                            ...
                            <th style="width:20%;"><?= lang("dob"); ?></th>
							<th style="width:30%;"><?= lang("address"); ?></th>
                            <th style="min-width:5% !important;"><?= lang("actions"); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                        ...
                        <tr class="active">
                            ...
                            <th style="min-width:5% !important;" class="text-center"><?= lang("actions"); ?></th>
                        </tr>
                        </tfoot>
                    </table>
                </div>
...
<script>
	$(document).ready(function() {
		$('body').on('click', '#SMS', function() {
			...
			$('#myModal').modal({remote: '<?=base_url('customers/send_sms');?>?data=' + arrItems + ''});
			$('#myModal').modal('show');
		});
	});
</script>
