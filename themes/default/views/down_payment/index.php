...
<script>
    ...
    $(document).ready(function () {
        var oTable = $('#QUData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('down_payment/getSales'. ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v?>',
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                ...
                nRow.id = aData[0];
                nRow.className = "down_payment_link";
                return nRow;
            },
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null, null, null, null, null,null, null, null, {"mRender": currencyFormat}, null, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": row_status_down}, {"bSortable": false}]
            ...
            {column_number: 12, filter_default_label: "[<?=lang('services_charge');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
		...
		<?php }else{ ?>
			<i class="fa-fw fa fa-heart-o"></i><?= lang('down_payment'); ?>
		<?php } ?>
        </h2>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <li>
							...
							<?php }else{ ?>
                            <a href="#" class="bpo" title="<?= $this->lang->line("delete_down_payment") ?>" 
                                data-content="<p><?= lang('r_u_sure') ?></p><button type='button' class='btn btn-danger' id='delete' data-action='delete'><?= lang('i_m_sure') ?></a> <button class='btn bpo-close'><?= lang('no') ?></button>" 
                                data-html="true" data-placement="left"><i class="fa fa-trash-o"></i> <?= lang('delete_down_payment') ?>
                            </a>
							<?php } ?>
                        </li>
                    </ul>
                ...
                <div class="table-responsive">
                    <table id="QUData" class="table table-bordered table-hover table-striped">
                        ...
                        <tr class="active">
                            ...
                            <th><?php echo $this->lang->line("services_charge"); ?></th>
