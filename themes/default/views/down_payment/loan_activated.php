...
<script>
    ...
    $(document).ready(function () {
        var oTable = $('#QUData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('down_payment/getLoanActivated'. ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v?>',
...
<div class="box">
    <div class="box-header">
		...
		<?php }else{ ?>
			<i class="fa-fw fa fa-heart-o"></i><?= lang('loan_activated'); ?>
		<?php } ?>
        </h2>
