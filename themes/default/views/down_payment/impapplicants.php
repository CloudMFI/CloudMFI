...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa fa-stack-overflow"></i><?= lang('import_applicants'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("down_payment/impApplicants", $attrib);
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="col-md-12">
                            ...
                            <div class="well well-sm">
                                <a href="<?php echo $this->config->base_url(); ?>assets/csv/sample_import_applicants.csv"
                                ...
                                <span class="text-info">
                                    <?php echo lang("identify_type") ?>
									,<?php echo lang("identify_id") ?>
                                    ,<?php echo lang("family_name_(eng)") ?>
                                    ,<?php echo lang("family_name_(kh)") ?>
									,<?php echo lang("first_name_(eng)") ?>
									,<?php echo lang("first_name_(kh)") ?>
                                    ,<?php echo lang("gender") ?>
                                    ,<?php echo lang("date_of_birth") ?>
                                    ,<?php echo lang("age") ?>
                                    ,<?php echo lang("phone_1") ?>
									,<?php echo lang("phone_2") ?>
									,<?php echo lang("marital_status") ?>
									,<?php echo lang("place_of_birth") ?>
									,<?php echo lang("nationality") ?>
									,<?php echo lang("country") ?>
									,<?php echo lang("province") ?>
									,<?php echo lang("district") ?>
									,<?php echo lang("communce") ?>
									,<?php echo lang("village") ?>
									,<?php echo lang("current_address") ?>
									,<?php echo lang("housing") ?>
									,<?php echo lang("years") ?>
									,<?php echo lang("months") ?>
									,<?php echo lang("issue_by") ?>
									,<?php echo lang("issue_date") ?>
