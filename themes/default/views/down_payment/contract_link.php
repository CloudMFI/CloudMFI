													...
													<div class="col-lg-12">
														...
														<div class="col-md-6">
															...
															<div class="form-group">
																...
																<?php echo form_input('cus_dob', $this->erp->hrsd($applicant->date_of_birth), 'class="form-control" id="cus_dob"'); ?>
															</div>
															<div class="form-group">
															...
															<div class="panel-body" style="padding: 5px;">
																	...
																	<div class="form-group">
																		...
																		<?php
																			foreach ($countries as $ctry) {
																				$emp_country[$ctry->id] = $ctry->name;
																			}
																			echo form_dropdown('emp_country', $emp_country, $quote_employee->country, 'class="form-control select" id="emp_country" placeholder="' . lang("select") . ' ' . lang("country") . '" style="width:100%" data-bv-notempty="true"');
																		?>
																	</div>
																</div>
																...
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<?php echo form_input('emp_province', ($quote_employee ? $quote_employee->province1 : ''), 'class="form-control" id="emp_province"  placeholder="' . lang("select_province") . '"');?>
																	</div>
																</div>
												...
												<div class="row">
													...
													<div class="col-md-6">
														...
														<div class="form-group">
															...
															<?php echo form_input('dob', $this->erp->hrsd($applicant->date_of_birth), 'class="form-control" id="dob"'); ?>
														</div>
														<div class="form-group">
