...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa fa-stack-overflow"></i><?= lang('import_service_details'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("down_payment/impContractsDetail", $attrib);
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="col-md-12">
                            ...
                            <div class="well well-sm">
                                <a href="<?php echo $this->config->base_url(); ?>assets/csv/sample_import_servcies.csv"
