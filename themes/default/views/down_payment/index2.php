...
<script>
    ...
    $(document).ready(function () {
        var oTable = $('#QUData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('down_payment/getQuotes'. ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null, null, null, null, {"mRender": left_side}, null, null, null, {"mRender": currencyFormat}, null, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": row_status}, {"bSortable": false}]
            ...
            {column_number: 10, filter_default_label: "[<?=lang('advance_payment_percentage');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart"></i><?=lang('contract_list') . ' ' . ($warehouse_id ? $warehouse->name : lang('')) . '';?>
        </h2>
		<div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                ...
                <div class="table-responsive">
                    <table id="QUData" class="table table-bordered table-hover table-striped">
                        ...
                        <tr class="active">
                            ...
                            <th><?php echo $this->lang->line("advance_payment_percentage"); ?></th>
                            <th><?php echo $this->lang->line("advance_payment"); ?></th>
                            <th><?php echo $this->lang->line("total_service_charge"); ?></th>
