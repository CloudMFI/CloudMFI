...
<script>
    ...
    $(document).ready(function () {
        var oTable = $('#QUData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('down_payment/getLoansCompleted'. ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            },null, null, null, null, null,{"mRender": fld}, null, null, null, null, null, null, {"mRender": currencyFormat}, {"bVisible": false},{"bVisible": false}, null, {"mRender": row_status_down}, {"bVisible": false}, {"bSortable": false}]
...
<div class="box">
    <div class="box-header">
		...
		<?php }else{ ?>
			<i class="fa-fw fa fa-heart-o"></i><?= lang('loans_pay_off'); ?>
		<?php } ?>
        </h2>
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
				...
				<div id="form">
                    <?php echo form_open("Down_Payment/loan_activated"); ?>
                    <div class="row">
