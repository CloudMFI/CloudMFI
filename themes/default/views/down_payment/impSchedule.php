...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa fa-stack-overflow"></i><?= lang('import_schedule'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("down_payment/impSchedule", $attrib);
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="col-md-12">
                            ...
                            <div class="well well-sm">
                                <a href="<?php echo $this->config->base_url(); ?>assets/csv/sample_import_schedule.csv"
                                ...
                                <span class="text-info">
                                    <?php echo lang("loan_reference") ?>
									,<?php echo lang("no.") ?>
                                    ,<?php echo lang("collection_date") ?>
                                    ,<?php echo lang("principle") ?>
									,<?php echo lang("interest") ?>
									,<?php echo lang("payment") ?>
                                    ,<?php echo lang("balance") ?>
                                    ,<?php echo lang("total_service_charge") ?>
                                    ,<?php echo lang("over_due_days") ?>
                                    ,<?php echo lang("penalty_amount") ?>
									,<?php echo lang("paid_amount") ?>
									,<?php echo lang("owed") ?>
									,<?php echo lang("paid_by") ?>
									,<?php echo lang("paid_date") ?>
									,<?php echo lang("note") ?>
