...
<script>
    ...
    $(document).ready(function () {
        var oTable = $('#QUData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('down_payment/getTransferLoanByCO'. ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null, null, null,  {"mRender": left_side}, null,null, {"mRender":fld}, {"mRender":fld}, {"mRender": currencyFormat}, {"bVisible": false}, {"bVisible": false}, null,{"bVisible": false}, {"mRender": row_status_down}, {"bSortable": false}]
            ...
            {column_number: 7, filter_default_label: "[<?=lang('submit_date');?>]", filter_type: "text", data: []},
            {column_number: 8, filter_default_label: "[<?=lang('appr_rej_date');?>]", filter_type: "text", data: []},
...
<?php if ($Owner || $Admin || $GP['quotes-transfer']) {
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
							<?php if($Owner || $Admin || $GP['quotes-co_transfer']){ ?>
								<a href="<?= site_url('down_payment/edit_transfer') ?>" data-toggle="modal" data-target="#myModal" id="add">
								   <i class="fa fa-plus-circle"></i> <?= lang('co_transfer') ?>
								</a>
							<?php } ?>
                        </li>
						<?php if ($Owner || $Admin || $GP['quotes-transfer']) {?>
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
				...
				<div id="form">
                    <?php echo form_open("down_payment/transfer_co"); ?>
                    <div class="row">
						<div class="col-sm-4">
