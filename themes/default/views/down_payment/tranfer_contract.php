...
<script>
    ...
    $(document).ready(function () {
        var oTable = $('#QUData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('down_payment/getTransferContracts'. ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null, null, null,  {"mRender": left_side}, null,null, {"bVisible": false}, {"bVisible": false}, {"mRender": currencyFormat}, {"bVisible": false}, {"bVisible": false}, {"mRender": currencyFormat},{"bVisible": false}, {"mRender": currencyFormat}, {"mRender": row_status_down}, {"bSortable": false}]
            ...
            <!--{column_number: 4, filter_default_label: "[<?=lang('dealer');?>]", filter_type: "text", data: []},-->
            ...
            {column_number: 8, filter_default_label: "[<?=lang('color');?>]", filter_type: "text", data: []},
            {column_number: 9, filter_default_label: "[<?=lang('price');?>]", filter_type: "text", data: []},
            {column_number: 10, filter_default_label: "[<?=lang('down_%');?>]", filter_type: "text", data: []},
            {column_number: 11, filter_default_label: "[<?=lang('advance_payment');?>]", filter_type: "text", data: []},
            {column_number: 12, filter_default_label: "[<?=lang('total_service_charge');?>]", filter_type: "text", data: []},
            {column_number: 13, filter_default_label: "[<?=lang('second_payment');?>]", filter_type: "text", data: []},
            {column_number: 14, filter_default_label: "[<?=lang('remaining');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue">
			<i class="fa-fw fa fa-heart-o"></i><?= lang('loan_transfer'); ?>
        </h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php
                                $bl[""] = "";
								if(is_array(isset($billers) ?$billers  : (''))){
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php
                                $wh[""] = "";
								if(is_array(isset($warehouses) ?$warehouses  : (''))){
                                foreach ($warehouses as $warehouse) {
...
<!--"aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null, null, null,  {"mRender": left_side}, null,null, null, null, {"mRender": currencyFormat}, null, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": row_status_down}, {"bSortable": false}]
       -->