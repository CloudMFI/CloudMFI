													...
													<div class="col-lg-12">
														<div class="col-md-6">
															...
															<div class="form-group">
																...
																<?php echo form_input('cus_sp_fname', $applicant->spouse_name, 'class="form-control" id="cus_sp_fname" required="required"'); ?>
															</div>
															<div class="form-group">
															...
															<div class="form-group">
																<?= lang("age", "cus_age"); ?>
																<?php echo form_input('cus_age', $applicant->age, 'class="form-control" id="cus_age" required="required"'); ?>
															</div>
															<div class="form-group">
																<?= lang("whose_income", "cus_whose_income"); ?>
																<?php echo form_input('cus_whose_income', $applicant->whose_income, 'class="form-control" id="cus_whose_income" required="required"'); ?>
															</div>
															<div class="form-group">
														...
														<div class="col-md-6">
															<?php if ($this->permission['reports-underwriting'] || $this->Admin || $this->Owner){ ?>
																	<div class="form-group">
																		<?= lang("status", "qstatus"); ?>
																		<?php
																		$status_q = array('quotation' => lang('quotation'), 'approved' => lang('approved'), 'rejected' => lang('rejected'), 'approved_condition' => lang('approved_condition'), 'pending_po' => lang('pending_po'));
																		if(isset($sale->sale_status) && $sale->sale_status == 'approved'){
																			unset($status_q['quotation']);
																		}
																		echo form_dropdown('status', $status_q, $applicant->status, 'id="qstatus" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("status") . '" required="required" class="form-control input-tip select" style="width:100%;"');
																		?>
																	</div>
															<?php } ?>
															<div class="form-group">
															...
															<div class="form-group">
																...
																$cus_inc_comb['0'] = "No";
																$cus_inc_comb['1'] = "Yes";
																echo form_dropdown('cus_inc_comb', $inc_comb, $applicant->income_combination, 'class="form-control select" id="cus_inc_comb" style="width:100%"');
																?>
															</div>
																...
																<div class="panel-body" style="padding: 5px;">
																	<div class="col-md-6">
																		...
																		<div class="form-group">
																			...
																			<?php
																			$cus_district[""] = "";
																			$cus_district["0"] = "Tek Thlar";
																			echo form_dropdown('cus_district', $cus_district, $applicant->district, 'class="form-control select" id="cus_district" placeholder="' . lang("select") . ' ' . lang("district") . '" style="width:100%" data-bv-notempty="true"');
																			?>
																		</div>
																		<div class="form-group">
																			...
																			<?php
																			$cus_province[""] = "";
																			$cus_province["0"] = "Kandal";
																			echo form_dropdown('cus_province', $cus_province, $applicant->state, 'class="form-control select" id="cus_province" placeholder="' . lang("select") . ' ' . lang("province") . '" style="width:100%" data-bv-notempty="true"');
																			?>
																		</div>
																		<div class="form-group">
																	...
																	<div class="col-md-6">
																		...
																		<div class="form-group">
																			...
																			$cus_village[""] = "";
																			$cus_village["0"] = "PCP";
																			echo form_dropdown('cus_village', $cus_village, $applicant->village, 'class="form-control select" id="cus_village" placeholder="' . lang("select") . ' ' . lang("village") . '" style="width:100%" data-bv-notempty="true"');
																			?>
																		</div>
																		<div class="form-group">
																			...
																			<?php
																			$cus_communce[""] = "";
																			$cus_communce["0"] = "Sen Sok";
																			echo form_dropdown('cus_communce', $cus_communce, $applicant->sangkat, 'class="form-control select" id="cus_communce" placeholder="' . lang("select") . ' ' . lang("communce") . '" style="width:100%" data-bv-notempty="true"');
																			?>
																		</div>
																		<div class="form-group">
															...
															<div class="col-sm-12">
																<div class="col-md-4">
																	<div class="form-group">
																		...
																		echo form_dropdown('category_id', $cat_all, $product->category_id, 'class="form-control category" required');
																		?>
																	</div>
																</div>
																...
																<div class="col-md-4">
																	<div class="form-group">
																		...
																		<?php
																		echo form_input('sub_category', $product->subcategory_id, 'class="form-control sub_category" id="sub_category"  placeholder="' . lang("select_category_to_load") . '"');
																		?>
																	</div>
																</div>
																...
																<div class="col-md-4">
																	<div class="form-group">
																		...
																		echo form_input('product_id', $product->product_id, 'class="form-control product_id" id="product_id"  placeholder="' . lang("select_product_to_load") . '" ');
																		?>
																	</div>
																</div>
