...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('edit_shareholder'); ?></h4>
        </div>
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
						...
						<?php
							...
							echo form_dropdown('jl_identify_id',$ident_all, $shareholder_info->identify, 'class="form-control jl_identify_type" id="jl_identify_type" placeholder="' . lang("select_identify_to_load") . '" data-bv-notempty="true"');																					
				...
				<div class="col-md-6">
                    <div class="form-group">	
						<div class="form-group">																
							<label id="jl_identify" for="jl_gov_id"><?php echo $shareholder_info->ident_name ?></label>
							<input type="hidden" name="jl_identify" id="jl_identify" class="jl_identify"  />
							<?php echo form_input('jl_gov_id', (isset($shareholder_info) ? $shareholder_info->gov_id : ''), 'class="form-control" id="jl_gov_id" data-bv-notempty="true"'); ?>
						</div>
					</div>
                </div>
				<div class="col-md-6">
                    <div class="form-group">	
						<?= lang("name", "name"); ?>
						<?php echo form_input('shareholder_name', (isset($shareholder_info) ? $shareholder_info->name : ''), 'class="form-control" id="shareholder_name" required="required"' ); ?>
					</div>
                </div>
				<div class="col-md-6">
					<div class="form-group">
						<?= lang("date_of_birth", "jl_dob"); ?>
						<?php echo form_input('jl_dob', (isset($shareholder_info) ? $this->erp->hrsd($shareholder_info->date_of_birth) : ''), 'class="form-control date" id="jl_dob" data-bv-notempty="true"'); ?>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						<?= lang("phone", "phone"); ?>
						<input type="tel" name="phone" class="form-control number_only" maxlength="10" id="phone" value="<?php echo (isset($shareholder_info) ? $shareholder_info->phone : '') ?>"/>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						<?= lang("age", "jl_age"); ?>
						<?php echo form_input('jl_age', (isset($shareholder_info) ? $shareholder_info->age : ''), 'class="form-control date" id="jl_age" style="pointer-events: none;"'); ?>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="controls">
							<input type="email" id="email" name="email" value="<?= (isset($shareholder_info->email)? $shareholder_info->email : '') ?>" class="form-control" required="required"/>
						</div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						...
						<?php echo form_input('cus_pob', (isset($shareholder_info->address) ? $shareholder_info->address : ''), 'class="form-control" id="cus_pob"'); ?>
					</div>
				</div>
				<div class="col-md-12 show_cash">
					<div class="form-group all">
						...
						<textarea name="ldescription" id="ldescription"
							  class="pa form-control kb-text ldescription">
							  <?= (isset($shareholder_info->house_no)? $shareholder_info->house_no : ''); ?>
						</textarea>
					</div>
				</div>
            </div>
