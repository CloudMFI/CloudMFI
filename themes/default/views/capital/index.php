<script>
    $(document).ready(function () {
        var oTable = $('#SupData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('capital/getCapital') ?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null, {"mRender": fld}, null, null,{"mRender": currencyFormat},null, null,{"bSortable": false}],
			...
			{column_number: 6, filter_default_label: "[<?=lang('currency');?>]", filter_type: "text", data: []},
			{column_number: 7, filter_default_label: "[<?=lang('bank_account');?>]", filter_type: "text", data: []},
           
        ], "footer");
    });
</script>
<?php if ($Owner) {
    echo form_open('capital/capital_actions', 'id="action-form"');
} ?>
<div class="box">
                ...
                <div class="table-responsive">
                    <table id="SupData" cellpadding="0" cellspacing="0" border="0" width="100%"
                        ...
                        <tr class="primary">
							...
							<th style="min-width:15%;"><?= lang("branch"); ?></th>
							<th style="min-width:15%;"><?= lang("amount"); ?></th>
							<th style="min-width:5px;"><?= lang("currency"); ?></th>
                            <th style="min-width:15%;"><?= lang("bank_account"); ?></th>
