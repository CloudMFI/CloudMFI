<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        echo form_open_multipart("branch/update/".$branch->id, $attrib); ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group company">
                        ...
                        <?php echo form_input('branch_code', (isset($branch->branch_code) ? $branch->branch_code: ''), 'class="form-control tip" id="branch_code" data-bv-notempty="true"'); ?>
                    </div>
				...
				<div class="col-md-6">
                    ...
                    <div class="form-group person">
                        ...
                        <?php echo form_input('branch_name', (isset($branch->name) ? $branch->name: ''), 'class="form-control tip" id="branch_name" data-bv-notempty="true"'); ?>
                    </div>
                </div>
				<div class="col-md-6">
                    <div class="form-group company">
                        <?= lang("tel", "tel"); ?>
                        <?php echo form_input('tel', (isset($branch->phone) ? $branch->phone: ''), 'class="form-control tip" id="tel" data-bv-notempty="true"'); ?>
                    </div>
                </div>
				<div class="col-md-6">
                    <div class="form-group person">
                        <?= lang("e_mail", "e_mail"); ?>
                        <?php echo form_input('e_mail', (isset($branch->email) ? $branch->email: ''), 'class="form-control tip" id="e_mail" data-bv-notempty="true"'); ?>
                    </div>
                </div>
				<div class="col-md-6">
					<div class="form-group" style="display:none;" >
						...
						<?php 
							...
							echo form_dropdown('default_purchase', $acc_section, '' ,'id="default_purchase" class="form-control" data-placeholder="' . $data->default_purchase . ' | ' . $purchase . '" style="width:100%;" multiple');
						?>
					</div>
				</div>
