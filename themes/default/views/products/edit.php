...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('update_product'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("products/updateProduct/".$product->id, $attrib)
                ?>
                ...
                <div class="col-md-8">
					...
					<div class="form-group all">
						...
						<div class="col-sm-9">
							<?php
								echo form_input('type', ($product ? $product->type : ''), 'class="form-control" id="type"  placeholder="' . lang("select_type") . '"');
							?>
					...
					<div class="form-group all">
						<label class="control-label col-sm-3"></label>
						<div class="col-sm-9">
							<input type="checkbox" value="1" name="group_loan" id="group_loan" <?= ($product->group_loan? 'checked':''); ?> />
							<label><?= lang("group_loan") ?></label>
						</div>
					</div>
