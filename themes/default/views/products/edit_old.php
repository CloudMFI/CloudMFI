    ...
    $(document).ready(function () {
        ...
        function add_product_item(item) {
            ...
            $.each(items, function () {
				...
				tr_html += '<td><input class="form-control text-center" name="combo_item_quantity_unit[]" type="text" value="' + formatDecimal(this.qty_unit) + '" data-id="' + row_no + '" data-item="' + this.id + '" id="quantity_' + row_no + '" onClick="this.select();"></td>';
