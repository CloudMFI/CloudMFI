                            ...
                            ?>
                                ...
                                <li class="mm_simulation">
                                    <a class="submenu" href="<?= site_url('simulation'); ?>">
                                        <i class="fa fa-comments"></i><span class="text"> <?= lang('simulation'); ?></span>
                                    </a>
                                </li> 
								
								<li class="mm_down_payment">
                                    <a class="submenu" href="<?= site_url('down_payment'); ?>">
                                        <i class="fa fa-comments"></i><span class="text"> <?= lang('down_payment'); ?></span>
                                    </a>
                                </li> 
								
								<li class="mm_installment_payment">
                                    <a class="submenu" href="<?= site_url('Installment_payment'); ?>">
                                        <i class="fa fa-comments"></i><span class="text"> <?= lang('installment_payment'); ?></span>
                                    </a>
                                </li> 
								<li class="mm_collection">
                                    <a class="submenu" href="<?= site_url('collection'); ?>">
                                        <i class="fa fa-comments"></i><span class="text"> <?= lang('collection'); ?></span>
                                    </a>
                                </li> 
								
								<li class="mm_daily_cash_collection">
                                    <a class="submenu" href="<?= site_url('daily_cash_collection'); ?>">
                                        <i class="fa fa-comments"></i><span class="text"> <?= lang('daily_cash_collection'); ?></span>
                                    </a>
                                </li>
                                        ...
                                        <ul>
                                            ...
                                            <?php if (POS) { ?>
                                                ...
                                                <?php } ?>
													...
													<li id="system_settings_down_persentages">
                                                        <a href="<?= site_url('system_settings/down_persentages') ?>">
                                                            <i class="fa fa-money"></i><span class="text"> <?= lang('down_persentages'); ?></span>
                                                        </a>
                                                    </li>
													<li id="system_settings_interest_rate">
                                                        <a href="<?= site_url('system_settings/interest_rate') ?>">
                                                            <i class="fa fa-money"></i><span class="text"> <?= lang('interest_rate'); ?></span>
                                                        </a>
                                                    </li>
													<li id="system_settings_term_in_month">
                                                        <a href="<?= site_url('system_settings/term_in_month') ?>">
                                                            <i class="fa fa-money"></i><span class="text"> <?= lang('term_in_month'); ?></span>
                                                        </a>
                                                    </li>
													...
													<li id="system_settings_financial_product">
														<a href="<?= site_url('system_settings/financial_product') ?>">
															<i class="fa fa-dollar"></i><span class="text"> <?= lang('financial_product'); ?></span>
														</a>
													</li>
                                    ...
                                    <?php } ?>
                                        ...
                                        <li class="mm_reports">
                                            ...
                                            <ul>
												...
												<!-- Sub Report -->
												<li id="mm_mm_reports">
                                                    <a class="dropmenu" href="#" href="<?= site_url('reports') ?>">
                                                        <i class="fa fa-bars"></i><span class="text"> <?= lang('operation'); ?></span>
														<span class="chevron closed"></span>
                                                    </a>
													<ul>
														<li class="mm_mm_reports_executive_summary_report">
															<a href="<?php echo base_url() ?>reports/executive_summary_report" style="padding-left:20px;">
																<i class="fa fa-sticky-note-o"></i><span class="text"> <?= lang('executive_summary'); ?></span>
															</a>
														</li>
														
														<li class="sub_sub_report">
															<a href="<?php echo base_url() ?>reports/executive_summary_report" style="padding-left:20px;">
																<i class="fa fa-sticky-note-o"></i><span class="text"> <?= lang('daily_contract'); ?></span>
															</a>
														</li>
														
														<li class="sub_sub_report">
															<a href="<?php echo base_url() ?>reports/executive_summary_report" style="padding-left:20px;">
																<i class="fa fa-sticky-note-o"></i><span class="text"> <?= lang('dealer_performance'); ?></span>
															</a>
														</li>
													</ul>
												...
												<li id="sub_reports_index">
													<a class="dropmenu" href="#" href="<?= site_url('reports') ?>">
														<i class="fa fa-underline"></i><span class="text"> <?= lang('underwriting'); ?></span>
														<span class="chevron closed"></span>
													</a>
													<ul>
														<li class="sub_sub_report">
														...
														<li class="sub_sub_report">
															<a href="<?php echo base_url() ?>reports/executive_summary_report" style="padding-left:20px;">
																<i class="fa fa-sticky-note-o"></i><span class="text"> <?= lang('application_process'); ?></span>
															</a>
														</li>
													</ul>
												...
												<li id="sub_reports_index">
													<a class="dropmenu" href="#" href="<?= site_url('reports') ?>">
														<i class="fa fa-building-o"></i><span class="text"> <?= lang('back_office'); ?></span>
														<span class="chevron closed"></span>
													</a>
													<ul>
														<li class="sub_sub_report">
														...
														<li class="sub_sub_report">
															<a href="<?php echo base_url() ?>reports/executive_summary_report" style="padding-left:20px;">
																<i class="fa fa-sticky-note-o"></i><span class="text"> <?= lang('active_contract'); ?></span>
															</a>
														</li>
														
														<li class="sub_sub_report">
															<a href="<?php echo base_url() ?>reports/executive_summary_report" style="padding-left:20px;">
																<i class="fa fa-sticky-note-o"></i><span class="text"> <?= lang('registration'); ?></span>
															</a>
														</li>
													</ul>
												...
												<li id="sub_reports_index">
													<a class="dropmenu" href="#" href="<?= site_url('reports') ?>">
														<i class="fa fa-globe"></i><span class="text"> <?= lang('collection'); ?></span>
														<span class="chevron closed"></span>
													</a>
													<ul>
														<li class="sub_sub_report">
														...
														<li class="sub_sub_report">
															<a href="<?php echo base_url() ?>reports/executive_summary_report" style="padding-left:20px;">
																<i class="fa fa-sticky-note-o"></i><span class="text"> <?= lang('overdue'); ?></span>
															</a>
														</li>
														
														<li class="sub_sub_report">
															<a href="<?php echo base_url() ?>reports/executive_summary_report" style="padding-left:20px;">
																<i class="fa fa-sticky-note-o"></i><span class="text"> <?= lang('repossessed'); ?></span>
															</a>
														</li>
													</ul>
												</li>
												<li id="sub_reports_index">
													<a class="dropmenu" href="#" href="<?= site_url('reports') ?>">
														<i class="fa fa-book"></i><span class="text"> <?= lang('accounting'); ?></span>
														<span class="chevron closed"></span>
													</a>
													<ul>
														<li class="sub_sub_report">
...
<li id="govreports_balance_sheet_tax">
                                                        ...
                                                        <?php } ?>
                                                            ...
                                                            <?php if ($GP['quotes-index']) { ?>
                                                                <li class="mm_quotes">
                                                                    <a class="dropmenu" href="#">
                                                                        <i class="fa fa-heart-o"></i>
																		<?php if ($GP['reports-back_office']) { ?>
																			<span class="text"> <?= lang('manage_contracts'); ?> </span>
																		<?php }else{ ?>
																			<span class="text"> <?= lang('manage_quotes'); ?> </span>
																		<?php } ?>
                                                                        <span class="chevron closed"></span>
                                                                    ...
                                                                    <ul>
                                                                        <li id="sales_index">
                                                                            <a class="submenu" href="<?= site_url('quotes'); ?>">
                                                                                <i class="fa fa-heart-o"></i>
																				<?php if ($GP['reports-back_office']) { ?>
																					<span class="text"> <?= lang('list_contracts'); ?></span>
																				<?php }else{ ?>
																					<span class="text"> <?= lang('list_quotes'); ?></span>
																				<?php } ?>
																...
																<?php if ($GP['daily_cash_collection-index']) { ?>
																<li class="mm_daily_cash_collection">
																	<a class="submenu" href="<?= site_url('daily_cash_collection'); ?>">
																		<i class="fa fa-comments"></i><span class="text"> <?= lang('daily_cash_collection'); ?></span>
																	</a>
								...
								<?php } ?>
                                    ...
                                    if ($GP['suppliers-add']) { ?>
                                                                                        ...
                                                                                        <?php } ?>
                                                                                            ...
                                                                                            <?php if ($GP['reports-products'] || $GP['reports-sales'] || $GP['reports-purchases'] || $GP['reports-account'] || $GP['reports-operation'] || $GP['reports-underwriting'] || $GP['reports-back_office'] || $GP['reports-collection']) { ?>
                                                                                                <li class="mm_reports">
                                                                                                    <a class="dropmenu" href="#">
                                                                                                        <i class="fa fa-bar-chart-o"></i>
                                                                                                        <span class="text"> <?= lang('reports'); ?> </span>
						...
						<?php } ?>
						<li id="reports_quantity_alerts">
							<a href="<?= site_url('reports/quantity_alerts') ?>"><i class="fa fa-bar-chart-o"></i>
