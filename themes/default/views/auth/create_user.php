                    ...
                    <div class="col-md-12">
                        <div class="col-md-5">
								<div class="form-group">
										...
										echo form_dropdown('branch', $branch, '', 'class="form-control select" id="branch" placeholder="' . lang("select") . ' ' . lang("branch") . '" style="width:100%" data-bv-notempty="true"');
										?>
								</div>
                            <div class="form-group">
                                <?php echo lang('first_name', 'first_name'); ?>
                                <div class="controls">
                                    <?php echo form_input('first_name', '', 'class="form-control" id="first_name" required="required" pattern=".{2,10}"'); ?>
                                </div>
                            </div>
                        ...
                        <div class="col-md-5 col-md-offset-1">
                            ...
                            <div class="no">
								...
								<div class="form-group">
                                    ...
                                    <div class="controls">
										<?php echo form_input('commission', '', 'class="form-control" id="commission"'); ?>
										<input type="hidden" name="commission_percentage" id="commission_percentage" class="commission_percentage"/>
									</div>
                                </div>
                                <div class="form-group">
							...
							<div class="row">
                                <div class="col-md-8">
                                    <label class="checkbox" for="shareholder">
                                        <input type="checkbox" name="shareholder" value="1" id="shareholder"/>
