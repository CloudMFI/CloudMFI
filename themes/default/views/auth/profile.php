<div class="row">
    ...
    <div class="col-sm-2">
        <div class="row">
            <div class="col-sm-12 text-center">
                ...
                <h4><?= lang('Username'); ?></h4>
                <p><i class="fa-fw fa fa-users"></i> <?= $user->username; ?></p>
                <h4><?= lang('email'); ?></h4>
                                        ...
                                        <div class="col-md-5">
											<div class="form-group">
												<?= lang("branch", "branch"); ?>
													<?php
													$branch['']='';
													foreach ($billers as $bh) {
														$branch[$bh->id] = $bh->name;
													}
													echo form_dropdown('branch', $branch, $branch_id->branch_id, 'class="form-control select" id="branch" placeholder="' . lang("select") . ' ' . lang("branch") . '" style="width:100%" data-bv-notempty="true"');
												?>
											</div>
                                            <div class="form-group">
															...
															<div class="col-md-12">
																<div class="col-md-12">
																	...
																	<div class="no">
																		...
																		<?php 
																			$commission_per = $user->commission;
																			$commission_percentage = $commission_per*100;
																		?>
																		<div class="form-group">
																			<?= lang("commission", "commission"); ?>
																			<?php echo form_input('commission', ($commission_percentage?$commission_percentage .'%':''), 'class="form-control tip" id="commission" data-bv-notempty="true"'); ?>
																			<input type="hidden" name="commission_percentage" id="commission_percentage" class="commission_percentage" value="<?= $user->commission ?>" />
																		</div>
																		<div class="form-group">
																...
																<div class="form-group">
																	<div class="row" style="margin-left:20px;">
																		<div class="col-md-8">
																			<label class="checkbox" for="shareholder">
																				<input type="checkbox" name="shareholder" value="1" id="shareholder" <?= ($user->shareholder? 'checked':''); ?>/>
																				<?= lang('i_am_a_shareholder') ?>
																			</label>
																		</div>
																		<div class="clearfix"></div>
																	</div>
    ...
    <script type="text/javascript" charset="utf-8">
		...
		/*----commission----*/
		$('#commission').live('change', function(e) {
			var commission_percentage = $(this).val().toLowerCase();
			var commission_per = 0;
			if(commission_percentage.search('%') > 0) {
				commission_percentage = commission_percentage.replace('%', '');
				commission_per = (commission_percentage/100);
			}else {
				rate = commission_percentage - 0;
				if(!Number(rate)) {
					commission_per = 0;
				}else {
			...
			$('#commission_percentage').val(commission_per);
			$('#commission_percentage').trigger('change');
		});
    </script>
<?php } ?>
