<?php
	//echo $default_currency->code; exit;
?>
<script type="text/javascript">
    ...
    var count = 1, an = 1, po_edit = false, product_variant = 0, DT = <?= $Settings? $Settings->default_tax_rate : "";?>, DC = '<?= $default_currency? $default_currency->code : ""; ?>', shipping = 0, product_tax = 0, invoice_tax = 0, total_discount = 0, total = 0, tax_rates = <?php echo json_encode($tax_rates); ?>, poitems = {}, audio_success = new Audio('<?= $assets ?>sounds/sound2.mp3'), audio_error = new Audio('<?= $assets ?>sounds/sound3.mp3');
                                    ...
                                    <table id="poTable"
                                        ...
                                        <tr>
                                            ...
                                            <th><?= lang("subtotal"); ?> (<span
                                                    class="currency"><?= (isset($default_currency->code ) ? $default_currency->code  : (''))?></span>)
                                            </th>
