<script>
    $(document).ready(function () {
        ...
        $('#CURData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('system_settings/getSMS') ?>',
            ...
            "aoColumns": [{"bSortable": false, "mRender": checkbox}, null, null, {"mRender": fld}, null, null, {"bSortable": false}]
        });
    });
</script>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?php echo site_url('system_settings/define_sms'); ?>" data-toggle="modal"
                               data-target="#myModal"><i class="fa fa-plus"></i> <?= lang('define_sms') ?></a></li>
                ...
                <div class="table-responsive">
                    <table id="CURData" class="table table-bordered table-hover table-striped table-condensed">
                        ...
                        <tr>
                            ...
                            <th><?php echo $this->lang->line("by_dealer"); ?></th>
                            <th><?php echo $this->lang->line("send_date"); ?></th>
                            <th><?php echo $this->lang->line("overdue_days"); ?></th>
