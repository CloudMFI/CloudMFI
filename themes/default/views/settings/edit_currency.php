    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div
                    class="controls"> <?php echo form_input('code', $currency->code, 'class="form-control" id="code" required="required" readonly'); ?> </div>
            </div>
            <div class="form-group">
            ...
            <?php if ($default_currency && $currency && $default_currency->code != $currency->code) { ?>
                <div class="form-group">
