            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
							...
							if(is_array($warehouses)){
                                ...
                                echo form_dropdown('warehouse', isset($wh) ?$wh  : (''), $Settings->default_warehouse, 'class="form-control tip" id="warehouse" required="required" style="width:100%;"');
                                ?>
                            </div>
                        </div>
                    </div>
					...
					<div class="col-md-4">
                        <div class="form-group">
                            <label class="control-label"
                                   for="business_type"><?= lang("business_type"); ?></label>

                            <?php
							$bl = array(0 => lang('leasing'), 1 => lang('mfi'));
							echo form_dropdown('business_type', $bl, $Settings->business_type, 'class="form-control tip" required="required" id="business_type" style="width:100%;"');
							?>
                        </div>
                    </div>
					...
					<div class="col-md-4">
                        <div class="form-group">
                            <label class="control-label"
                                   for="business_type"><?= lang("advance_approve_amount"); ?></label>

                            <?php echo form_input('ad_app_amount', $this->erp->formatMoney($settings->adv_app_amount), 'class="form-control tip" id="ad_app_amount"'); ?>
                        </div>
                    </div>
					<div class="col-md-4">
						<?= lang("interest_discount", "interest_discount"); ?>
						<?php
						$interest_discount[(isset($_POST['interest_discount']) ? $_POST['interest_discount'] : '')] = (isset($_POST['interest_discount']) ? $_POST['interest_discount'] : '');
						$interest_discount['enable'] = "Enable";
						$interest_discount['disable'] = "Disable";
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <?php
                                    $ref = array(1 => lang('prefix_name_ym_no'), 2 => lang('prefix_year_no'), 3 => lang('prefix_month_year_no'), 4 => lang('sequence_number'), 5 => lang('random_number'), 6 => lang('prefix_dealer_sequence_number'));
						...
						<!--
						<div class="col-md-4">
							<?= lang("penalty_types", "cus_penalty_types"); ?>
							<?php
							$cus_penalty_types[(isset($_POST['cus_penalty_types']) ? $_POST['cus_penalty_types'] : '')] = (isset($_POST['cus_penalty_types']) ? $_POST['cus_penalty_types'] : '');
							$cus_penalty_types['fixed'] = "Fixed";
							$cus_penalty_types['percentage'] = "Percentage";
							echo form_dropdown('cus_penalty_types', $cus_penalty_types, isset($Settings->penalty_types)?$Settings->penalty_types:'', 'class="form-control select" id="cus_penalty_types" placeholder="' . lang("select") . ' ' . lang("penalty_types") . '" style="width:100%" data-bv-notempty="true"')
							?>
						</div>
                    ...
                    <fieldset class="scheduler-border">
						...
						<div class="col-md-4">
							<div class="form-group">
								<?= lang('collateral_prefix','collateral_prefix'); ?>
								<?= form_input('collateral_prefix',$settings->collateral_prefix,'class="form-control tip" id="collateral_prefix"'); ?>
							</div>
						</div>
                    </fieldset>
					...
					<fieldset class="scheduler-border">
                        <legend class="scheduler-border"><?= lang('sms_notifier') ?></legend>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label" for="protocol"><?= lang("id"); ?></label>
                                <div class="controls"> <?php
                                    echo form_input('auth_id', $Settings->sms_auth_id, 'class="form-control" id="auth_id" style="width:100%;"');
                                    ?>
                                </div>
                            </div>
                        </div>
						<div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label" for="protocol"><?= lang("taken"); ?></label>
                                <div class="controls"> <?php
                                    echo form_input('auth_taken', $Settings->sms_auth_taken, 'class="form-control" id="auth_taken" style="width:100%;"');
                                    ?>
                                </div>
                            </div>
                        </div>
						<div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label" for="protocol"><?= lang("link"); ?></label>
                                <div class="controls"> <?php
                                    echo form_input('sms_link', $Settings->sms_link, 'class="form-control" id="sms_link" style="width:100%;"');
                                    ?>
                                </div>
                            </div>
                        </div>
