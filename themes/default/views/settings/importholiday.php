...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa fa-stack-overflow"></i><?= lang('import_holiday'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("System_settings/importholiday", $attrib);
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="col-md-12">
                            ...
                            <div class="well well-sm">
                                <a href="<?php echo $this->config->base_url(); ?>assets/csv/sample_holidays.csv"
                        ...
                        <div class="col-md-12">
                            <div
                                class="fprom-group"><?php echo form_submit('impotholiday', $this->lang->line("import"), 'id="impotholiday" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
