<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('edit_term'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
        echo form_open_multipart("system_settings/update_term/".$row->id."", $attrib); ?>
        ...
        <div class="modal-footer">
            <?php echo form_submit('update_term', lang('update_term'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
