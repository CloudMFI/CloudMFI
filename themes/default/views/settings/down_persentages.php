<script>
    $(document).ready(function () {
        ...
        $('#CURData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('system_settings/getDown_persentages') ?>',
...
<?= form_open('system_settings/down_persentages_action', 'id="action-form"') ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?php echo site_url('system_settings/add_down_persentages'); ?>" data-toggle="modal"
                               data-target="#myModal"><i class="fa fa-plus"></i> <?= lang('add_down_persentages') ?></a></li>
                        ...
                        <li><a href="#" id="delete" data-action="delete"><i
                                    class="fa fa-trash-o"></i> <?= lang('delete_down_persentages') ?></a></li>
