...
<script>
    $(document).ready(function () {
        ...
        var oTable = $('#EXPData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('system_settings/getFinancial').'/?v=1'.$v; ?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null, null, null, {"mRender": currencyFormat}, null,null,null,null, {"mRender": inactives}, {"bSortable": false}],
			...
			{column_number: 3, filter_default_label: "[<?=lang('description_other');?>]", filter_type: "text", data: []},
            {column_number: 5, filter_default_label: "[<?=lang('method');?>]", filter_type: "text", data: []},
			{column_number: 6, filter_default_label: "[<?=lang('charge_by');?>]", filter_type: "text", data: []},
			{column_number: 7, filter_default_label: "[<?=lang('paid_status');?>]", filter_type: "text", data: []},
			{column_number: 8, filter_default_label: "[<?=lang('tax');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-dollar"></i><?= lang('financial_product'); ?></h2>
		<!--
		<div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
						<?php if ($Owner || $Admin) { ?>
							<li><a href="<?= site_url('system_settings/add_financial') ?>" data-toggle="modal"
                               data-target="#myModal"><i class="fa fa-plus-circle"></i> <?= lang('add_financial') ?></a>
							</li>
							<!--
							<li>
							...
							-->
							<li class="divider"></li>						
							<!--<li><a href="#" class="bpo" title="<?= $this->lang->line("delete_service") ?>"
								   data-content="<p><?= lang('r_u_sure') ?></p><button type='button' class='btn btn-danger' id='delete' data-action='delete'><?= lang('i_m_sure') ?></a> <button class='btn bpo-close'><?= lang('no') ?></button>"
								   data-html="true" data-placement="left"><i
										class="fa fa-trash-o"></i> <?= lang('delete_service') ?></a></li>-->
						<?php }else{ ?>
                    ...
                    <table id="EXPData" cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover table-striped">
                        <thead>
							<tr class="active">
								...
								<th class="col-xs-2"><?php echo $this->lang->line("description"); ?></th>
								<th class="col-xs-2"><?php echo $this->lang->line("description_other"); ?></th>
								<th class="col-xs-2"><?php echo $this->lang->line("amount"); ?></th>
								<th class="col-xs-2"><?php echo $this->lang->line("method"); ?></th>
								<th class="col-xs-2"><?php echo $this->lang->line("charge_by"); ?></th>
								<th class="col-xs-2"><?php echo $this->lang->line("paid_status"); ?></th>
								<th class="col-xs-2"><?php echo $this->lang->line("tax"); ?></th>
