...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo form_open_multipart("system_settings/add_financial", $attrib); ?>
        <div class="modal-body">
			...
			<div class="form-group all">
				...
				<div class="form-group all" style="border: solid 1px #ccc; height:40px; padding:10px;">					
					<div class="col-sm-4">
						<b>Loan Amount</b>	
						<input type="checkbox" name="loan_amount" id="loan_amount"/>
					</div>
					<div class="col-sm-4">
						<b>Remaing Balance</b>	
						<input type="checkbox" name="remaing_balance" id="remaing_balance"/>
					</div>
					<div class="col-sm-4">
						<b>Payment Amount</b>	
						<input type="checkbox" name="payment_amount" id="payment_amount"/>
					</div>					
				</div>
			</div> 
			...
			<div class="form-group all">
				<div class="form-group">
					...
					<?php
						...
						echo form_dropdown('accrued_service_income', $acc_section, '' ,'id="accrued_service_income" class="form-control" placeholder="' . lang("select") . ' ' . lang("accrued_service") . '" style="width:100%;" required="required"');
					?>
				</div>
			</div>
