<script>
    $(document).ready(function () {
        ...
        $('#CURData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('system_settings/getidentifyTypes/'.$id) ?>',
...
<?= form_open('system_settings/identify_types_actions', 'id="action-form"') ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?php echo site_url('system_settings/add_identify_types/'); ?>" data-toggle="modal"
                               data-target="#myModal"><i class="fa fa-plus"></i> <?= lang('add_identify_types') ?></a></li>
                        <li class="divider"></li>
                        <li><a href="#" id="delete" data-action="delete">
								<i class="fa fa-trash-o"></i> <?= lang('delete_identity_types') ?>
							</a>
						</li>
                    </ul>
                </li>
                ...
                <div class="table-responsive">
                    <table id="CURData" class="table table-bordered table-hover table-striped table-condensed">
                        ...
                        <tr>
                            ...
                            <th><?php echo $this->lang->line("identify_types"); ?></th>
