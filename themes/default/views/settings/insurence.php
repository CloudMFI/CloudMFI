...
<script>
    $(document).ready(function () {
        ...
        var oTable = $('#EXPData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('system_settings/getinsurence').'/?v=1'.$v; ?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null, null, null, {"mRender": currencyFormat}, null,null,{"mRender": inactives}, {"bSortable": false}],
			...
			{column_number: 6, filter_default_label: "[<?=lang('tax_rate');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-dollar"></i><?= lang('insurance'); ?></h2>
		<!--
		<div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
						<?php if ($Owner || $Admin) { ?>
							<li><a href="<?= site_url('system_settings/add_insurence') ?>" data-toggle="modal"
                               data-target="#myModal"><i class="fa fa-plus-circle"></i> <?= lang('add_insurence') ?></a>
							</li>
							<!--
							<li>
							...
							-->
							<li class="divider"></li>						
							<!--<li><a href="#" class="bpo" title="<?= $this->lang->line("delete_insurence") ?>"
								   data-content="<p><?= lang('r_u_sure') ?></p><button type='button' class='btn btn-danger' id='delete' data-action='delete'><?= lang('i_m_sure') ?></a> <button class='btn bpo-close'><?= lang('no') ?></button>"
								   data-html="true" data-placement="left"><i
										class="fa fa-trash-o"></i> <?= lang('delete_insurence') ?></a></li>-->
						<?php }else{ ?>
                    ...
                    <table id="EXPData" cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover table-striped">
                        <thead>
							<tr class="active">
								...
								<th class="col-xs-3"><?php echo $this->lang->line("method"); ?></th>
								<th class="col-xs-3"><?php echo $this->lang->line("tax_rate"); ?></th>
								<th class="col-xs-4"><?php echo $this->lang->line("status"); ?></th>
