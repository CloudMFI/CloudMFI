<script>
    $(document).ready(function () {
        ...
        $('#CURData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('system_settings/get_holidays/'.$id) ?>',
            ...
            "aoColumns": [{"bSortable": false, "mRender": checkbox},  {"mRender": fld},null,{"bSortable": false}]
        });
    });
</script>

<?= form_open('system_settings/holidays_actions', 'id="action-form"') ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?php echo site_url('system_settings/add_holidays'); ?>" data-toggle="modal"
                               data-target="#myModal"><i class="fa fa-plus"></i> <?= lang('add_holidays') ?></a></li>
                        <li class="divider"></li>
