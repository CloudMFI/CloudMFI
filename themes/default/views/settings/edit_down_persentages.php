<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('edit_down_persentages'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
        echo form_open_multipart("system_settings/update_down_persentages/".$row->id."", $attrib); ?>
        ...
        <div class="modal-footer">
            <?php echo form_submit('update_down_persentages', lang('update_down_persentages'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
