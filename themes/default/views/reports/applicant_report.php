...
<script>
    ...
    $(document).ready(function () {
        var oTable = $('#QUData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('report/getQuotes'. ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null, null,null, null, {"mRender": left_row}, {"mRender": row_status}, {"mRender": fld}, {"mRender": fld}, {"mRender": fld},  {"mRender": left_side},null,{"mRender": currencyFormat}, {"bSortable": false}]
            ...
            {column_number: 10, filter_default_label: "[<?=lang('acceptation_date');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
		...
		<?php }else{ ?>
			<i class="fa-fw fa fa-heart-o"></i><?= lang('quotation_list'); ?>
		<?php } ?>
        </h2>
