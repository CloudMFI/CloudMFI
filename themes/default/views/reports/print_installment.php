<?php //$this->erp->print_arrays($installment_info); ?>
...
<div class="box">
    <div class="box-header">
        <h2 class="blue">
			<i class="fa-fw fa fa-heart-o"></i><?= lang('daily_repayments'); ?>
        </h2>
		<div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
				...
				<!---Start Search------->
				<div id="form">
					<?php echo form_open('Reports/print_installment/', 'id="action-form"'); ?>
				...
				<div class="clearfix"></div>
					<p style="font-size:20px; text-align:center;"> 
						<B> <?= lang("daily_repayments"); ?>  <?= date('d/m/Y'); ?>   </B>
					</p>
                    <table id="QUData" class="table table-bordered table-hover table-striped table-responsive">
						...
						$remaining_amt = 0;
							foreach($installment_info as $ins_info){
								...
								foreach($services as $service) {
									...
									$total_inst = $ins_info->principles + $ins_info->interest_rate + $ins_info->owed + $total_services;
									$installment_amt = $defualt_principle + $defualt_interest + $defualt_owed + $defualt_service;
								...
								<tr>
									...
									<!--<td style="text-align:right;"><?= $this->erp->formatMoney($ins_info->principles); ?></td>-->
						...
						<?php $i++; }?>
						<tr>
							<td colspan="8" style="text-align:right; font-weight:bold;"><?= lang('sub_total') ?></td>
							...
							<td style="text-align:right; font-weight:bold;"><?= $this->erp->formatMoney(str_replace(',','',$this->erp->roundUpMoney($total_owedy, $setting->default_currency)));?></td>
