...
<script>
    ...
    $(document).ready(function () {
        var oTable = $('#QUData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('Reports/Contracts'. ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v?>',
            ...
            {column_number: 11, filter_default_label: "[<?=lang('price');?>]", filter_type: "text", data: []},
...
<?php if ($Owner) {
    echo form_open('Reports/Report_Payment_actions', 'id="action-form"');
} ?>
<div class="box">
        ...
        <div class="row">
            <div class="col-lg-12">
				...
				<div id="form">
                    ...
                    <?php echo form_open("Reports/contract_list"); ?>
                    <div class="row">
						<div class="col-sm-4">
