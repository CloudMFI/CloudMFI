						...
						<li class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu"
                                ...
                                foreach ($billers as $biller) {
                                    echo '<li ' . ($biller_id && $biller_id == $biller->id ? 'class="active"' : '') . '><a href="' . site_url('reports/balance_sheet/'.$start.'/'.$end.'/0/0/' . $biller->id) . '"><i class="fa fa-building"></i>' . $biller->company . '</a></li>';
                                }
                                ?>
                            </ul>
                        </li>
                ...
                <div class="table-responsive">
                    <table id="SupData" cellpadding="0" cellspacing="0" border="0" class="table table-bordered">
                        ...
                        <?php
							...
							$total_income_beforeAyear = isset($queryIncom->amount)?$queryIncom->amount:'';
							...
							$total_expense_beforeAyear = isset($queryExpense->amount)?$queryExpense->amount:'';
