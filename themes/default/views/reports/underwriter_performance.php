...
<script>
    ...
    $(document).ready(function () {
        var oTable = $('#QUData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/underwriter_getQuotes'. ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v?>',
            ...
            {column_number: 8, filter_default_label: "[<?=lang('appr/rej_date');?>]", filter_type: "text", data: []},
            {column_number: 9, filter_default_label: "[<?=lang('acceptation_date');?>]", filter_type: "text", data: []},
			{column_number: 10, filter_default_label: "[<?=lang('duration');?>]", filter_type: "text", data: []},				
            {column_number: 11, filter_default_label: "[<?=lang('underwriter');?>]", filter_type: "text", data: []},			
			{column_number: 12, filter_default_label: "[<?=lang('created_by');?>]", filter_type: "text", data: []},
			{column_number: 13, filter_default_label: "[<?=lang('total');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue">
			<i class="fa-fw fa fa-heart-o"></i><?= lang('underwriter_performance'); ?>
        </h2>
        ...
        <div class="row">
            <div class="col-lg-12">
				...
				<div id="form">
                    ...
                    <?php echo form_open("reports/underwriter_performance"); ?>
                    <div class="row">
						<div class="col-sm-4">
