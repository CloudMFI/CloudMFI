            ...
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="SupData" cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover table-striped table-condensed">
						...
						<?php
								$total_13 = 0;
								foreach($data13->result() as $row13){
									if ($row13->amount>0){
							?>
								<tr>
									<td colspan="2" style="padding-left:30px">
										<a href="<?= site_url('reports/0/0/'.$biller_id.'?w=1'.$from_st.$to_st.'&account='.$row13->account_code) ?>">
											<?php echo $row13->account_code;?> - <?php echo $row13->accountname;?>
										</a>
									</td>
									<td>
										<span class="pull-right">
											<?php echo number_format(abs($row13->amount),2); $total_C += $row13->amount;?>
										</span>
									</td>
								</tr>
							<?php } else { ?>	
								<tr>
									...
									<td></td>
									<td><span class="pull-right"><?php echo number_format(abs($row13->amount),2); $total_D += $row13->amount;?></span>
									</td>
								</tr>
