...
foreach ($quotation_status as $monthly_income) {
	$row_income = abs($monthly_income->total);
	$expend = (isset($monthly_income->cost)?$monthly_income->cost:''+isset($monthly_income->operation)?$monthly_income->operation:'');
	$months[] = date('d-M', strtotime($monthly_income->MONTH));
	$income[] = $row_income;
	$cost[] = $monthly_income->grand_total;
	$operation[] = $monthly_income->advance_payment;
	$profit[] = $row_income-$expend;
	$purchases[] = isset($month_sale->purchases)?$month_sale->purchases:'';
	$tax3[] = isset($month_sale->ptax)?$month_sale->ptax:'';
}}
    ?>
            ...
            $('#chart').highcharts({
                ...
                series: [{
                    ...
                    ?>]
                        ...
                        type: 'spline',
                        name: '<?= lang("Accumulated Contract"); ?>',
                        data: [<?php
                    echo implode(', ', $profit);
                    ?>],
                        marker: {
...
<?php if ($Owner || $Admin) { ?>
    <div class="box" style="margin-top: 15px;">
        <div class="box-header">
            <h2 class="blue"><i class="fa-fw fa fa-bar-chart-o"></i><?= lang('Summary Report'); ?></h2>
			<div class="box-icon">
						<ul class="btn-tasks">
        ...
        <div class="box-content">
            <div class="row">
                ...
                <div id="form_search">
                    ...
                    <?php echo form_open("reports/summary_report"); ?>
                    <div class="row">
