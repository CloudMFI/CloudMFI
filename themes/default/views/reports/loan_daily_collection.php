...
<script>
    $(document).ready(function () {
        ...
        var oTable = $('#PayRData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getDailyLoanReport/?v=1' . $v) ?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null, {"mRender": ref}, {"mRender": ref},{"mRender": ref},null ,{"mRender": paid_by},null, {"mRender": currencyFormat}, {"mRender": row_status}],
			...
			{column_number: 7, filter_default_label: "[<?=lang('penalty_days');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-money"></i><?= lang('loan_daily_collection'); ?> <?php
            if ($this->input->post('start_date')) {
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports/getDailyLoanReport"); ?>
                    <div class="row">
                        <div class="col-sm-4">
