<html>
	<head>
		<title>Loan Break down Currency</title>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="text-center" >
						...
						<h4 style="margin-left:40%;padding-bottom:20px;">LOAN&nbsp;BREAKDOWN&nbsp;BY&nbsp;CURRENCY</h4>
					</div>	  
                ...
                <table style="width: 155%;">				
					<tbody style="font-size: 15px;">
						<tr style="text-align:center;">	
							...
							<td style="width:15%;vertical-align:middle;"></td>
							<td style="width:15%;vertical-align:middle;text-align:right;padding-right:5px;">In Million Riels</td>
							<td style="width:10%;vertical-align:middle;text-align:right;padding-right:5px;">4,006</td>							
						</tr>
