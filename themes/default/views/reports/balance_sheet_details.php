        ...
        <div class="row">
            <div class="col-lg-12">
				...
				<p style="font-size:20px; text-align:center;">  
					<B> <?= lang("balance_sheet_details"); ?>  </B>
				</p>
					...
					<?php
						...
						if($this->uri->segment(7)){
							...
							foreach($dataAsset->result() as $row){
								...
								$assetDetails = $this->accounts_model->getBalanceSheetDetailByAccCode($row->account_code, '10,11,13,15',$from_date,$end_dates,$biller_id);
						...
						?>
							...
							foreach($dataEquity->result() as $rowequity){
								...
								//$this->erp->print_arrays($eqDetails);
								$index = 0;
								$total_per_lib = 0;
								...
								foreach($eqDetails->result() as $eqD){
									...
									echo '<td><div class="fix-text">'. $eqD->description.'</div></td>';
									?>
