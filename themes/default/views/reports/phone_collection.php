...
<script>
    ...
    $(document).ready(function () {
        var oTable = $('#QUData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('Installment_payment/getSalesReport'. ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null,null, null, null, null, {"mRender": fld}, null, null, null, 
            ...
            {column_number: 6, filter_default_label: "[<?=lang('payment_date');?>]", filter_type: "text", data: []},
            {column_number: 7, filter_default_label: "[<?=lang('over_due_days');?>]", filter_type: "text", data: []},
            {column_number: 8, filter_default_label: "[<?=lang('underwriter');?>]", filter_type: "text", data: []},
            {column_number: 9, filter_default_label: "[<?=lang('branch');?>]", filter_type: "text", data: []},
            //{column_number: 10, filter_default_label: "[<?=lang('total');?>]", filter_type: "text", data: []},
            {column_number: 10, filter_default_label: "[<?=lang('mfi');?>]", filter_type: "text", data: []},
        ], "footer");
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart"></i><?=lang('intallment_payment') . ' ' . ($warehouse_id ? $warehouse->name : lang('')) . '';?>
        </h2>
		<div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">                            
							<div class="form-group">
                                ...
                                <?php echo form_input('customer', (isset($_POST['customer']) ? $_POST['customer'] : ""), 'class="form-control" id="customer" data-placeholder="' . $this->lang->line("select") . " " . $this->lang->line("by_branch") . '"'); ?>
                            </div>
                        </div>
						<div class="col-sm-4">
                            <div class="form-group">
