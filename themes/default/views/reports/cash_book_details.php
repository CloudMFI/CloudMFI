...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-th-large"></i><?= lang('cash_book_details'); ?><?php
            if ($this->input->post('start_date')) {
							...
							if ($this->input->post('start_date') || $this->input->post('end_date') || (!$this->input->post('end_date') && !$this->input->post('end_date'))) {
								...
								foreach($acc as $val){
									...
									<tr>
										...
										<td style="text-align:center;"><?=$rw->tran_no?></td>
										<td style="text-align:left;"><?=$rw->narrative?></td>
										<td><?=$rw->tran_date?></td>
										<td><?=$rw->tran_type?></td>
