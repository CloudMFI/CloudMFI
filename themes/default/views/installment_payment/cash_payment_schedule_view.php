		...
		<div class="modal-body">
			<div class="row">
				<div class="container">
					...
					<table style="width:100%;height:40px;border-top: 1px solid black;border-bottom: 1px solid black;margin-top:5px;font-size:11px;font-weight: normal;"> <!-- MSM add 1/12/2017-->
						<tr>
