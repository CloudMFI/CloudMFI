...
<?php
	...
	$penalty_amount = $this->erp->convertCurrency($sale_item->currency_code, $setting->default_currency, $payment->penalty_amount + $payment->owed_penalty);
	...
	//$this->erp->print_arrays($sale_item->currency_code);
?>
					...
					<div class="row">
						<div class="col-md-12">							
							<div class="tab-content">
									...
									echo form_open_multipart("Installment_payment/edit_payments/" . $loan_id .'/'. $sale_id .'/'. $payment->id, $attrib ); 
									?>
																...
																<div class="col-md-12">
																	...
																	<div class="col-md-6">
																		...
																		<div class="form-group">
																			...
																			<input type="file" class="file" data-show-preview="false" data-show-upload="false" name="document" id="document">
																		</div>
																	</div>								
																</div>								
																<div class="col-md-12">
																...
																<div class="col-md-12">
																	...
																	<div class="col-md-6" >
																		<div class="form-group">
																			...
																			<?php echo form_input('interest',$this->erp->roundUpMoney($interest_amount, $sale_item->currency_code), 'class="form-control" id="interest" '); ?>
																		</div>
																	</div>
																	<!--<div class="col-md-6" >
																		<div class="form-group">
