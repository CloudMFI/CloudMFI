<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo form_open_multipart("Installment_payment/changePaymentDate", $attrib); ?>
                    ...
                    <tbody>
						<?php foreach($loans as $loan) { ?>
							<tr>
								...
								<td class="text-center"> <input type="hidden" name="old_payment_date[]" class="form-control payment_date date" value="<?= $this->erp->hrsd($loan->dateline) ?>" /> </td>
							</tr>
						<?php } ?>
					</tbody>
