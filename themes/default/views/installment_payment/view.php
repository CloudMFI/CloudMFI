...
<div class="box">
    ...
    <div class="box-content">
        ...
        <?php } ?>
		<div class="row padding10 no-print">
			<div class="row" style="padding:5px;">
				<div class="col-md-6 text-right">
					<input class="checkbox" type="checkbox" name="authorized"/>
				</div>
			...
			<div class="row" style="padding:5px;">
				<div class="col-md-6 text-right">
					<input class="checkbox" type="checkbox" name="inactived"/>
				</div>
				<div class="col-md-6 text-left">
					<?= lang('inactived') ?>
				</div>
			...
			<div class="btn-group">
				<a href="<?= site_url('sales/payments/' . $inv->id) ?>" data-toggle="modal" data-target="#myModal" class="tip btn btn-primary tip" title="<?= lang('submit') ?>">
					<span class="hidden-sm hidden-xs"><?= lang('submit') ?></span>
				</a>
			</div>
		</div>
    </div>
