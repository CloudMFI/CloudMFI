		...
		<div style=" height:100px; padding-left:15px;font-size:10px;line-height: 18px;">
			<table width="100%">
				...
				<div style=" width:100%;min-height:100px; padding-top:15px; padding-left:10px;">				 
					...
					<p>
						ေခ်းေငြ မေပးသြင္းနိုင္ပါက ၀ိုင္းၾကီးခ်ဳပ္စနစ္ျဖင့္  အဖြဲ႕ အမွတ္ <b><?= $group_name->name; ?></b> ၏ အဖြဲ႕၀င္မ်ားႏွင့္ပူးတဲြ ေငြေခ်းသူတို႔က အညီအမွ် တာ၀န္ယူေျဖရွင္းေပးမည္ ျဖစ္ေၾကာင္းလက္မွတ္ေရးထိုး ပါသည္။
					</p>	
				</div>
