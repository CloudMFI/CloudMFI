...
?>
<style>
	#QUData,#QUData_weekly,#QUData_two_week,#QUData_monthly, #QUData_yearly{
		overflow-x: scroll;
		max-width: 100%;
		min-height: 300px;
		display: block;
...
<script>
    ...
    $(document).ready(function () {
		var oTable = $('#QUData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('Installment_payment/getDailyPayments'. ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null,null, null, null, null, {"mRender": fld}, {"mRender": fld}, null, null, {"mRender": currencyFormat}, {"bVisible": false},null,
			...
			{column_number: 11, filter_default_label: "[<?=lang('remaining');?>]", filter_type: "text", data: []},
...
<script>
    ...
    $(document).ready(function () {
        var oTable = $('#QUData_weekly').dataTable({
            "aaSorting": [[0, "desc"]],
            "aLengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "<?= lang('all') ?>"]],
            "iDisplayLength": <?= $Settings->rows_per_page ?>,
            'bProcessing': true, 'bServerSide': true,
            'sAjaxSource': '<?= site_url('Installment_payment/getWeeklyPayment'. ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v?>',
            'fnServerData': function (sSource, aoData, fnCallback) {
                aoData.push({
                    "name": "<?= $this->security->get_csrf_token_name() ?>",
                    "value": "<?= $this->security->get_csrf_hash() ?>"
...
<script>
    ...
    $(document).ready(function () {
        var oTable = $('#QUData_two_week').dataTable({
            "aaSorting": [[0, "desc"]],
            "aLengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "<?= lang('all') ?>"]],
            "iDisplayLength": <?= $Settings->rows_per_page ?>,
            'bProcessing': true, 'bServerSide': true,
            'sAjaxSource': '<?= site_url('Installment_payment/getTwoWeekPayment'. ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v?>',
            'fnServerData': function (sSource, aoData, fnCallback) {
                aoData.push({
                    "name": "<?= $this->security->get_csrf_token_name() ?>",
                    "value": "<?= $this->security->get_csrf_hash() ?>"
...
<script>
    ...
    $(document).ready(function () {
        var oTable = $('#QUData_monthly').dataTable({
            "aaSorting": [[0, "desc"]],
            "aLengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "<?= lang('all') ?>"]],
            "iDisplayLength": <?= $Settings->rows_per_page ?>,
            'bProcessing': true, 'bServerSide': true,
            'sAjaxSource': '<?= site_url('Installment_payment/getMonthlyPayment'. ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v?>',
            'fnServerData': function (sSource, aoData, fnCallback) {
                aoData.push({
                    "name": "<?= $this->security->get_csrf_token_name() ?>",
                    "value": "<?= $this->security->get_csrf_hash() ?>"
...
<script>
    ...
    $(document).ready(function () {
        var oTable = $('#QUData_yearly').dataTable({
            "aaSorting": [[0, "desc"]],
            "aLengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "<?= lang('all') ?>"]],
            "iDisplayLength": <?= $Settings->rows_per_page ?>,
            'bProcessing': true, 'bServerSide': true,
            'sAjaxSource': '<?= site_url('Installment_payment/getYearlyPayment'. ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v?>',
            'fnServerData': function (sSource, aoData, fnCallback) {
                aoData.push({
                    "name": "<?= $this->security->get_csrf_token_name() ?>",
                    "value": "<?= $this->security->get_csrf_hash() ?>"
...
<!----------------------------------------------------------------------------------------------------------->
	...
	<div class="box">
		<div class="box-header">
			<h2 class="blue"><i
					class="fa-fw fa fa-heart"></i><?=lang('frequency_payments') . ' ' . ($warehouse_id ? $warehouse->name : lang('')) . '';?>
			</h2>
			<div class="box-icon">
				<ul class="btn-tasks">
					<li class="dropdown">
				...
				<div class="row">
					<div class="col-md-12">
						<ul id="dbTab" class="nav nav-tabs">
							<li class="" id="today_installment_tap"><a href="#daily_installment"><?= lang('daily_payments') ?></a></li>
							<li class="" id="weekly_installment_tap"><a href="#weekly_installment"><?= lang('weekly_payments') ?></a></li>
							<li class="" id="two_week_installment_tap"><a href="#two_week_installment"><?= lang('two_weeks_payments') ?></a></li>
							<li class="" id="monthly_installment_tap"><a href="#monthly_installment"><?= lang('monthly_payments') ?></a></li>
							<li class="" id="yearly_installment_tap"><a href="#yearly_installment"><?= lang('yearly_payments') ?></a></li>
						</ul>
						<!------Daily Installment Payment------>
						<div class="tab-content">								
							<div id="daily_installment" class="tab-pane fade in">
								<div class="row">
									<div class="col-sm-12">
						...
						<div class="tab-content">								
							<div id="weekly_installment" class="tab-pane fade in">
								<div class="row">
									<div class="col-sm-12">
										<div class="table-responsive">
											<div class="row">
												...
												<!-------->
													<div class="table-responsive">
														<table id="QUData_weekly" class="table table-bordered table-hover table-striped">
															<thead>
															<tr class="active">
																<th style="min-width:30px; width: 30px; text-align: center;">
																	<input class="checkbox checkft" type="checkbox" name="check"/>
						...
						<!------End weekly Installment Payment ------->
						
						<!------Two Week Installment Payment------>
						<div class="tab-content">								
							<div id="two_week_installment" class="tab-pane fade in">
								<div class="row">
									<div class="col-sm-12">
										<div class="table-responsive">
											<div class="row">
												...
												<!-------->
													<div class="table-responsive">
														<table id="QUData_two_week" class="table table-bordered table-hover table-striped">
															<thead>
															<tr class="active">
																<th style="min-width:30px; width: 30px; text-align: center;">
																	<input class="checkbox checkft" type="checkbox" name="check"/>
						...
						<!------End Two week Installment Payment ------->
						
						<!------Monthly Installment Payment------>
						<div class="tab-content">								
							<div id="monthly_installment" class="tab-pane fade in">
								<div class="row">
									<div class="col-sm-12">
										<div class="table-responsive">
											<div class="row">
												...
												<!-------->
													<div class="table-responsive">
														<table id="QUData_monthly" class="table table-bordered table-hover table-striped">
															<thead>
															<tr class="active">
																<th style="min-width:30px; width: 30px; text-align: center;">
																	<input class="checkbox checkft" type="checkbox" name="check"/>
						...
						<!------Yaerly Installment Payment------>
						<div class="tab-content">								
							<div id="yearly_installment" class="tab-pane fade in">
								<div class="row">
									<div class="col-sm-12">
										<div class="table-responsive">
											<div class="row">
												...
												<!-------->
													<div class="table-responsive">
														<table id="QUData_yearly" class="table table-bordered table-hover table-striped">
															<thead>
															<tr class="active">
																<th style="min-width:30px; width: 30px; text-align: center;">
																	<input class="checkbox checkft" type="checkbox" name="check"/>
						...
						<!------End Yaerly Installment Payment ------->
