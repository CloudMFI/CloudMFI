		...
		<div class="contain-wrapper" style="padding:10px;">
			<div style="margin-top:20px; margin-left:15px;">
				<div class="header" style="width:100%;float:left; ">
					<div class="brand-name" style="width:35%; float:left; margin-left:30px;">
					...
					<div style="width:60%; float:right;margin-top:20px;">
						<div>
							<p style="font-family:Khmer OS Muolfont-size:12px;"><b> <?php echo $setting->site_name ?> </b></p>					
						</div>
						<div>
							<p style="font-size:9px;"> E N A T E A N &nbsp; L E R K S T U O Y &nbsp; S A M A T E P E A P &nbsp; K R U O S A &nbsp; P l c </p>					
						</div>
					</div>				
				</div>
				<div class="header" style="width:100%;float:left;">
					...
					<div class="nationality-identifier" style="width:70%; float:left;margin-top:0px;position:relative;">
						...
						<div>
							<p style="text-align:center;"> លិខិតប្រគល់ និងទទួលប្រាក់ </p>					
						</div>
					</div>				
					<div style="width:10%; float:left;margin-top:10px;"></div>				
				</div>
				...
				<div style="width:85%;float:left;text-align:right; margin-right:100px;">
					<p> ថ្ងៃទី &nbsp <b><?php echo $this->erp->hrsd($contract_info->reference_no)?> </b> &nbsp </p>			
				</div>
			...
			<div style="margin-left:15px;">
				<div class="header" style="width:100%;float:left;">
					<div class="brand-name" style="width:10%; float:left;margin-top:20px; margin-left:30px;">
						
					</div>				
					<div class="nationality-identifier" style="width:70%; float:left;margin-top:10px;position:relative;">
						<div style="float:left;" id="logo">
							<span> 
								<?php if ($Settings->logo2) {
									echo '<img src="' . site_url() . 'assets/uploads/logos/' . $Settings->logo2 . '" style="margin-bottom:10px;" />';
				...
				<div class="header" style="width:100%;float:left;">
					...
					<div class="nationality-identifier" style="width:70%; float:left;margin-top:0px;position:relative;">
						...
						<div>
							<p style="text-align:center;font-size:9px;"> E N A T E A N &nbsp; L E R K S T U O Y &nbsp; S A M A T E P E A P &nbsp; K R U O S A &nbsp; P l c </p>					
						</div>
						<div>
							<p style="text-align:center;"> លិខិតប្រគល់ និងទទួលប្រាក់ </p>					
						</div>
				...
				<div style="width:85%;float:left;text-align:right">
					<p> ថ្ថៃទី &nbsp <b><?php echo $this->erp->hrsd($contract_info->reference_no)?> </b> &nbsp </p>			
				</div>
				<div style="width:100%;float:left;text-align:center">
					<div style="width:30%; float:left;">
						<p>តំណាងម្ចាស់កម្ចី</p>
