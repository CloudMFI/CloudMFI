		...
		<center><p style="font-weight:bold;">កាលវិភាគបង់ប្រាក់ប្រចាំខែ Monthly Payment Schedule</p></center>
			...
			<table  style="margin-top:15px;font-size:11px;border:2px solid black;width:100%;">
				...
				<tr>
					...
					<td  class="t_c td_dashed color_green" id="l_lease_amount">N/A</td><td></td>
				</tr>
				...
				<tr>
					...
					<td  class="t_c td_dashed color_green" id="advance_payment_paid"></td>
			...
			<table style="margin-top:15px;font-size:11px;border-collapse:collapse;width:100%;">
				...
				$total=$this->erp->formatMoney($data["principle"]+$data["interest"]);;
...
$(document).ready(function() {
	...
	var advance_payment = Advance_payment_rate * price;
	var lease_amount = price - advance_payment;
	$( "#phone" ).text( phone );
	...
	$( "#advance_payment_paid" ).text(formatMoney(advance_payment));
	$( "#l_lease_amount" ).text(formatMoney(lease_amount));
