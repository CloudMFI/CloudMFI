                                            ...
                                            <div class="btn-group btn-group-justified">
                                                <div class="btn-group">
                                                    <button type="button" style="height:68px;" class="btn btn-warning addButton" id="search_details">
                                                        <i class="fa fa-print"></i> <?= lang('products'); ?>
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
		...
		if($pos_settings->show_suspend_bar == 40){
			if($suspend->inactive == 1){
				...
				echo "<span style='position:relative'>
					<a id='clear_suspend' hrefs='".base_url()."pos/delete_suspend/".$suspend->ids."' style='text-decoration:none;position:absolute;top:0%;left:0;position:absolute;' class='btn-danger clear_suspend'>clear</a>
			...
			echo "<span style='position:relative'>
					<a id='clear_suspend' hrefs='".base_url()."pos/delete_room/".$suspend->sid."' style='text-decoration:none;position:absolute;top:0%;left:0;position:absolute;' class='btn-danger clear_suspend'>clear</a>
            ...
            <div class="modal-body" id="pr_popover_content">
                <form class="form-horizontal" role="form" id="s_seModal">
					<table>
						<thead>
							<tr>
								<td style="padding:0;margin:0;border:1px;"><input type="text" style="width:173px;border-right:none" class="form-control" id="Pcode"/></td>
								<td style="padding:0;margin:0;border:1px;"><input type="text" style="width:134px;border-right:none" class="form-control" id="Pname"/></td>
								<td style="padding:0;margin:0;border:1px;"><input type="text" style="width:104px;border-right:none" class="form-control" id="Pdescription" /></td>
								<td style="padding:0;margin:0;border:1px;"><input type="text" style="width:94px;border-right:none" class="form-control" id="Pcategory" ></td>
								<td style="padding:0;margin:0;border:1px;"><input type="text" style="width:63px;" class="form-control" id="Pprice"></td>
							</tr>
						</thead>
					</table>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#product-list, #suspend-slider, #category-list, #subcategory-list, #suspend-list').perfectScrollbar({suppressScrollX: true});
        $('select, .select').select2({minimumResultsForSearch: 6});
    ...
    function Popup(data) {
		...
		*/
		...
		//mywindow.document.write(table_b);
		mywindow.document.write(data);
		mywindow.document.write('<hr>');
		mywindow.document.write('<div class="well well-sm" style="text-align:center"> <?= $this->erp->decode_html($biller->invoice_footer); ?></div>');
