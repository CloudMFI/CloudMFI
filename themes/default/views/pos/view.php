            ...
            <table class="table table-striped table-condensed receipt">
				...
				?>
                    ...
                    <tr>
                        ...
                        <th style="border-top:2px dotted #000" class="text-right"><?= number_format(abs((($pay+$money_kh) - $inv->grand_total)*$exchange_rate->rate)) . ' ៛' ; ?></th>
                    </tr>
				<?php
						}
					}else{
                    ...
                    <tr>
                        <th style="border-top:2px dotted #000;padding-right: 12px;" colspan="<?= $colspan ?>" class="text-right"><?= lang("remaining_kh"); ?></th>
                        <th style="border-top:2px dotted #000" class="text-right"><?= number_format(abs((($pos_paid+$amount_kh_to_us) - $inv->grand_total)*$exchange_rate->rate)) . ' ៛' ; ?></th>
                    </tr>
