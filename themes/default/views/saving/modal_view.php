<div class="modal-dialog modal-lg no-modal-header">
    <div class="modal-content">
        <div class="modal-body">
            ...
            <div class="buttons stick-button">
                ...
                <div class="btn-group btn-group-justified">
                    ...
                    <div class="btn-group"><a href="<?= site_url('quotes/email/' . $inv->id) ?>"
                                              class="tip btn btn-info tip"
                                              title="<?= lang('credit_check') ?>"><i class="fa fa-envelope-o"></i> <span
                                class="hidden-sm hidden-xs"><?= lang('credit_check') ?></span></a></div>
					<div class="btn-group"><a href="<?= site_url('quotes/field_check/' . $inv->id) ?>" data-toggle="modal"
                                              data-target="#myModal" class="tip btn btn-info tip"
                                              title="<?= lang('field_check') ?>"><i class="fa fa-envelope-o"></i> <span
                                class="hidden-sm hidden-xs"><?= lang('field_check') ?></span></a></div>
		...
		<div class="text-center padding10 no-print well well-sm">
			<div class="row" style="padding:5px;">
				<div class="col-md-6 text-right">
					<input class="checkbox apv" type="checkbox" name="authorized"/>
				</div>
			...
			<div class="row" style="padding:5px;">
				<div class="col-md-6 text-right">
					<input class="checkbox rej" type="checkbox" name="inactived"/>
				</div>
				<div class="col-md-6 text-left">
					<?= lang('rejected') ?>
				</div>
			...
			<div class="btn-group" style="padding:10px;">
				<a href="<?= site_url('sales/payments/' . $inv->id) ?>" data-toggle="modal" data-target="#myModal" class="tip btn btn-primary tip" title="<?= lang('submit') ?>">
					<span class="hidden-sm hidden-xs" style="padding:0px 30px;"><?= lang('submit') ?></span>
				</a>
			</div>
		</div>
		<?php } ?>
