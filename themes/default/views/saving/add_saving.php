...
<div class="modal-dialog modal-lg no-modal-header" style="width:60%; margin-top:150px;">
    <div class="modal-content">
		<div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo $this->lang->line('add_saving'); ?></h4>
        </div>
		<?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
        echo form_open_multipart("saving/add_saving/" . $sales->id, $attrib); ?>
			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div class="panel panel-primary">
						<div class="panel-heading"><?= lang('add_saving') ?></div>
							<?php echo form_open('saving', 'id="action-form"'); ?>
							<div class="row">
								<div class="col-md-12">
									<div class="col-md-6">									
										<div class="form-group">
											...
											<?php echo form_input('pay_date', (isset($_POST['pay_date']) ? $_POST['pay_date'] : date('d/m/Y')), 'class="form-control date" id="pay_date" data-bv-notempty="true"'); ?>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<?= lang("reference", "reference"); ?>
											<?php echo form_input('reference', $reference, 'class="form-control" id="reference" data-bv-notempty="true" style="pointer-events: none;"'); ?>
										</div>
									</div>
								</div>
								<div class="col-md-12">
