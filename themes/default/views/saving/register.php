					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="tab-content">
								...
								echo form_open_multipart("saving/open_account", $attrib)
								?>
								...
								<div id="saving_products" style="display: none;" class="tab-pane fade">
									<div class="row">
										<div class="col-sm-12">
														...
														<div class="col-sm-12">
															...
															<div class="col-md-6">
																<div class="form-group all">
																	<?= lang("amount", "price") ?>
																	<?= form_input('price', (isset($_POST['price']) ? $_POST['price'] : ''), ' class="form-control" id="price" style="font-size:20px;" data-bv-notempty="true"') ?>
											...
											<div class="col-sm-12">
												<div class="panel panel-primary">
													<div class="panel-heading"><?= lang('saving_products') ?></div>
													<div class="panel-body" style="padding: 5px;">
