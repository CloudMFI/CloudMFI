...
<script type="text/javascript">
	...
	$(window).load(function() {
		...
		<?php } else if($inv->status == 'approved'){ ?>	
			$('.form-control').attr("disabled",true);
			$('input:submit').css("display","none");
		<?php } ?>
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-edit"></i><?= lang('view_details'); ?></h2>
    </div>
		...
		.top_bar div{ color:white;}
            ...
            <div class="col-lg-12">
					<div class="row top_bar" style="background-color: #428bca; margin-left: -20px; margin-right: -20px; padding-bottom: 5px; padding-top: 5px;">	
						<div class="col-md-3"><?=lang('name');?><span style="margin-left:20px;">: <?php echo $applicant->family_name.' '.$applicant->name;?></span></div>
						...
						<div class="col-md-3"><?=lang('amount');?><span style="margin-left:4px;">: <?php echo $settings->penalty_days;?></div>
						<div class="col-md-3"><?=lang('interest_rate');?><span style="margin-left:7px;">: <?php echo $settings->penalty_amount;?></span></div>
						
						<div class="col-md-3"><?=lang('status');?><span style="margin-left:40px;">: <?php echo ' '.$quote->status;?></span></div>
				...
				<div class="col-md-12" style="margin-top: 20px;">
							<ul id="dbTab" class="nav nav-tabs">
								<li class=""><a href="#applicants"><?= lang('register') ?></a></li>								
								<li class=""><a href="#financial_products"><?= lang('saving_products') ?>
								<li class=""><a href="#transation"><?= lang('money_transation') ?>
								<li class=""><a href="#withdrawal"><?= lang('withdrawal') ?>
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	<?= lang("status", "qstatus"); ?>
																	<?php
																	$status_q = array('applicant' => lang('applicant'), 'approved' => lang('approved'), 'rejected' => lang('rejected'), 'approved_condition' => lang('approved_condition'), 'pending_po' => lang('pending_po'));
																	if(isset($sale->sale_status) && $sale->sale_status == 'approved'){
																		unset($status_q['quotation']);
																	}
																	if($setting->adv_app_amount < $product->unit_price && !$GP['advance-approve'] && !$this->Admin && !$this->Owner) {
															...
															<div class="col-md-6" <?= (($inv->mfi != '1')? 'style="display:none;"' : ''); ?> >
																<div class="form-group">
																	...
																	<?php echo form_input('st_inst_date', ($applicant ? $this->erp->hrsd($applicant->installment_date) : ''), 'class="form-control input-tip date"  id="st_inst_date" style="pointer-events:none;"'); ?>
																</div>
															</div>
														</div>
													<?php } ?>
													...
													<div class="panel panel-primary">
														...
														<div class="panel-body" style="padding: 5px;">
															<div class="col-sm-12">
																...
																<div class="col-md-4">
																	<div class="form-group all">
																		<?= lang("price") ?><span style="margin-left:77px;">:</span>
