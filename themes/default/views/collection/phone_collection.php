...
<script>
    ...
    $(document).ready(function () {
        var oTable = $('#QUData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('collection/getPhoneCollection'. ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v?>',
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                ...
                nRow.id = aData[0];
                nRow.className = "phone_collection_link";
                return nRow;
            },
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null, null, null,null,null,null, {"mRender": fld}, {"mRender": fld}, null, null, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"bSortable": false}]
            ...
            //{column_number: 7, filter_default_label: "[<?=lang('collector_name');?>]", filter_type: "text", data: []},
            ...
            {column_number: 12, filter_default_label: "[<?=lang('services_fee');?>]", filter_type: "text", data: []},
            {column_number: 13, filter_default_label: "[<?=lang('penalty_amount');?>]", filter_type: "text", data: []},
            {column_number: 14, filter_default_label: "[<?=lang('total_amount');?>]", filter_type: "text", data: []},
        ], "footer");
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart"></i><?=lang('Collection') . ' ' . ($warehouse_id ? $warehouse->name : lang('')) . '';?>
        </h2>
		<div class="box-icon">
			<!--
		  <ul class="btn-tasks">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?=site_url('collection/add_phone_collection')?>" data-toggle="modal" data-target="#myModal">
                                <i class="fa fa-plus-circle"></i> <?=lang('add_phone_collection')?>
                            </a>
                        </li>
						<!--
						<?php if ($Owner || $Admin) { ?>
                ...
                <div class="table-responsive">
                    <table id="QUData" class="table table-bordered table-hover table-striped">
                        ...
                        <tr class="active">
                            ...
                            <th><?php echo $this->lang->line("phone_status"); ?></th>
                            <!--<th><?php echo $this->lang->line("collector_name"); ?></th>-->
