														...
														<div class="col-md-6"style="margin-top:15px;">
															...
															<div class="col-md-4">
																...
																<div>
																	...
																	<input type="file" class=" file" data-show-preview="false" data-show-upload="false" name="applicant_photo" id="document">
																</div>
															</div>
														</div>
													</div>
													...
													<div class="col-lg-12">
														<div class="col-md-6">
															...
															<div class="form-group" id="spphone">
																...
																<input type="tel" name="cus_sp_phone" maxlength="10" class="form-control number_only" id="cus_sp_phone"/>
															</div>
																...
																<div class="panel-body" style="padding: 5px;">
																	<div class="col-md-6">
																		<div class="form-group">
																			...
																			echo form_dropdown('cus_country', $cus_country, isset($customer->country)?$customer->country:'', 'class="form-control select" id="cus_country" data-placeholder="' . lang("select") . ' ' . lang("country") . '" style="width:100%" required="required"');
																			?>
																		</div>
																		<div class="form-group">
																	...
																	<div class="col-md-6">
																		<div class="form-group">
																			...
																			<?php echo form_input('cus_province', isset($customer->province)?$customer->province:'', 'class="form-control" id="cus_province"  placeholder="' . lang("select_province") . '" required="required"');?>
																		</div>
																		<div class="form-group">
														...
														<div class="panel-body" style="padding: 5px;">
															<div class="col-sm-12">
																...
																<div class="col-md-4">
																	<div class="form-group all">
																		<?= lang("amount", "price") ?>
																		<?= form_input('price', (isset($_POST['price']) ? $_POST['price'] : ''), ' class="form-control" id="total_amoun" style="font-size:20px;" ') ?>
													...
													<div class="panel panel-primary">
														...
														<div class="panel-body" style="padding: 5px;">
															...
															<div class="col-sm-12">
																...
																<div class="col-md-4">
																	<div class="form-group">
																		<?php echo form_checkbox(['name' => 'ch_services[]', 'id' => $k, 'class' => 'ch_services','service_paid' => $service->service_paid, 'title' => $service->description, 'amount' => $service->amount, 'status' => $service->method, 'value' => $service->id]); ?>
																	</div>
																</div>
																<?php
																if($k == 0) {
															...
															<div class="col-lg-6">
																<div class="form-group">
																	...
																	*/
																	...
																	<?= form_input('interest_rate_cash_2', (isset($inv->rate_text ) ? $inv->rate_text : ''), ' class="form-control" id="interest_rate_cash_2" style="font-size:14px;" ') ?>
															...
															<div class="panel-body" style="padding: 5px;">
																...
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<?php echo form_input('work_phone', (isset($_POST['work_phone']) ? $_POST['work_phone'] : ''), 'class="form-control input-tip number_only" maxlength="10" id="work_phone" '); ?>
																	</div>
																</div>
															...
															<div class="panel panel-primary">
																...
																<div class="panel-body" style="padding: 5px;">																	
																	<div class="col-md-6">																		
																		...
																		<div class="form-group">
																			<?= lang("phone", "phone_1"); ?>
																			<input type="tel" name="phone_1" class="form-control number_only" maxlength="10" id="phone_1" />
																		</div>
																		<div class="form-group">
																			<?= lang("job", "j_job_1"); ?>
															...
															<div class="panel panel-primary">
																...
																<div class="panel-body" style="padding: 5px;">
																	...
																	<div class="col-md-6">
																		...
																		<div class="form-group">
																			<?= lang("phone", "phone_2"); ?>
																			<input type="tel" name="phone_2" class="form-control number_only" maxlength="10" id="phone_2"/>
																		</div>
																		<div class="form-group">
																			<?= lang("job", "j_job_2"); ?>
