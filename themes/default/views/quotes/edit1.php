												...
												<div class="row">
													...
													<div class="col-lg-12">
														<div class="col-md-6">
															...
															<input type="hidden" name="reference_no" value="<?= $inv->reference_no ?>" />
															<div class="form-group">
															...
															<div class="col-sm-12">
																...
																<div class="col-md-4">
																	<div class="form-group"  id="ch_services_">
																		<?php 
																			echo form_checkbox(['name' => 'ch_services[]', 'id' => $k, 'class' => 'ch_services', 'amount' => $service->amount, 'status' => $service->method, 'value' => $service->id, 'service_paid' => $service->service_paid, 'checked' => $service->checked]); 
																		?>
																	</div>
																</div>
																<?php
														...
														<div class="panel-body" style="padding: 5px;">
															...
															<div class="col-lg-6">
																<div class="form-group">
																	...
																	<?php echo form_input('st_inst_date', ($applicant ? $this->erp->hrsd($applicant->installment_date) : ''), 'class="form-control date" id="st_inst_date"'); ?>
																</div>
